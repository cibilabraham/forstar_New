																					...
																					<table border="0">
																						...
																						<tr id="additonalWastage" width="500px">
																							<?php 
																								...
																								{
																								echo'<td colspan="3" align="right"><table width="86%">';								
																								$l=0;
																							...
																							<td colspan="4">
																								<table>
																									<tr>
																										...
																										<input type="text" name="total_new_entry" id="total_new_entry" value="<?php echo $m;?>" />	
																										</tbody>
																										<?php 
																										}		
																										...
																										{																						
																										?>
																											<input type="text" name="total_new_entry" id="total_new_entry" value="<?php echo sizeof($qualityRecords);?>" />
																										<?php
																										}
																										else
																										{
