...
#List all Stock Issuance
	$stockRequisitionRecords		=	$stockRequisitionObj->fetchAllRecords();
					...
					<td   bgcolor="white">
						...
						<table cellpadding="0"  width="100%" cellspacing="0" border="0" align="center">
							<tr>
								...
								<td  colspan="2" background="images/heading_bg.gif" class="pageName" >&nbsp;Stock Requisition</td>
							</tr>
							<tr>
