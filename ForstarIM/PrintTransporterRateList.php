<?php
	...
	$transporterRateListRecords	=	$transporterRateListObj->fetchAllRecords($transporterFilterId);
?>
					...
					<td   bgcolor="white">
						...
						<table cellpadding="0"  width="100%" cellspacing="0" border="0" align="center">
							<tr>
								...
								<td  colspan="2" background="images/heading_bg.gif" class="pageName" >&nbsp;Transporter Rate List</td>
							</tr>
							<tr>
...
<table cellpadding="1"  width="75%" cellspacing="1" border="0" align="center" bgcolor="#999999">
		...
		?>
			...
			<td class="listing-head" nowrap style="padding-left:10px; padding-right:10px;">Transporter</td>
                      </tr>
                      <?
			foreach ($transporterRateListRecords as $dmrl) {
				$i++;
				$transporterRateListId	=	$dmrl[0];
