<?php
	...
	#List All Records	
	$areaDemarcationRecords		= $areaDemarcationMasterObj->fetchAllRecords();
					...
					<td   bgcolor="white">
						...
						<table cellpadding="0"  width="100%" cellspacing="0" border="0" align="center">
							<tr>
								...
								<td  colspan="2" background="images/heading_bg.gif" class="pageName" >&nbsp;Area Demarcation Master</td>
							</tr>
							<tr>
