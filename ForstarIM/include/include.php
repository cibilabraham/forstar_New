...
require("lib/GstMaster_class.php");
require("lib/IgstMaster_class.php");
...
//KD watermark 13-11-19
require("lib/WaterMarkPage_class.php");
...
// $dailyFreezingObj 			= new DailyFreezing($databaseConnect);
 ...
 $igstMasterObj			=	new IgstMaster($databaseConnect);  
...
//KD watermark 13-11-19
$waterMarkObj = new WaterMark($databaseConnect);
