						...
						<td   bgcolor="white">
							...
							<table cellpadding="0"  width="100%" cellspacing="0" border="0" align="center">
								<tr>
									...
									<td  colspan="2" background="images/heading_bg.gif" class="pageName" >TYPE OF OPERATIONS</td>
								</tr>								
								<tr>
								...
								<tr>
									...
									<td colspan="2" >
										<table cellpadding="1"  width="65%" cellspacing="1" border="0" align="center" bgcolor="#999999">
											...
											<?
												foreach($operationTypeRecords as $eucr) {
													$i++;
													$euCodeId	=	$eucr[0];
													$optName	=	stripSlash($eucr[1]);
													$description	=	stripSlash($eucr[2]);
													
											?>
											<tr  bgcolor="WHITE"  >
												<td class="listing-item" nowrap style="padding-left:5px; padding-right:5px;"><?=$optName;?></td>
												<td class="listing-item" nowrap style="padding-left:5px; padding-right:5px;"><?=$description;?></td>	
											</tr>
											<?
													}
											?>
