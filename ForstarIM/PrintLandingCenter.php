					...
					<td   bgcolor="white">
						...
						<table cellpadding="0"  width="100%" cellspacing="0" border="0" align="center">
							<tr>
								...
								<td  colspan="2" background="images/heading_bg.gif" class="pageName" >&nbsp;Landing Centers</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<table cellpadding="1"  width="90%" cellspacing="1" border="0" align="center" bgcolor="#999999">
											...
											?>
											<tr  bgcolor="WHITE"  >
												<td class="listing-item" nowrap >&nbsp;&nbsp;<?=$centerCode;?></td>
												<td class="listing-item" >&nbsp;&nbsp;<?=$centerName;?></td>
												<td class="listing-item" >&nbsp;&nbsp;<?=$centerDesc;?></td>
											</tr>
											<?
													}
											?>
