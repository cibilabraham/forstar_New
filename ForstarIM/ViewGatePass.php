<?php	
	...
	# Get Gate Pass Main Id
	$gatePassId = $manageGatePassObj->gatePassMainId($selSOId);
	$confirmed = false;
	...
	if ($selSOId) $pOGenerateId	= ($invoiceType!="S")?(($pOGenerateId!=0)?$pOGenerateId:"P$proformaInvoiceNo"):$sampleInvNo;
