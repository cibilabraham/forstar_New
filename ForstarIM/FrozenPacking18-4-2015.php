																	...
																	<tr>
																		...
																		<td colspan="2" >
																			<table cellpadding="0"  width="100%" cellspacing="0" border="0" align="center">
																											...
																											<TD valign="top">
																												<table>
																													...
																													<tr>
																														...
																														<td class="listing-item">
																															<select name="freezing" id="freezing" onchange="return calculateFilledWt();">
																																<option value="">--select--</option>
																																<?
																				...
																				<tr>
																					<td  height="10" colspan="4" align="center" style="padding-left:10px;padding-right:10px;">
																						<table width="80%">
																							<TR>
																								<TD>
																								<!--<fieldset><legend class="listing-item">Rate Details</legend>-->
																									...
																									<table width="100%" cellpadding="0" cellspacing="0" > 
																										...
																										<TR>
																											<TD>
																												<iframe name="iFrame2" id="iFrame2" src="frozenProcessorRateList.php?lastId=<?=$lastId?>&editId=<? if($editMode==true) echo 1;?>" width="550" frameborder="0" height="150"></iframe>
																											</td>
																										</tr>
																									</table>
																									<?php
