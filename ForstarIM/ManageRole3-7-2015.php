													...
													foreach ($getFunctionRecords as $gfr) {
													  ...
													  <tr bgcolor="#FFFFFF" id="<?=$k."_".$j?>" style="display:none"> 
														<td class="listing-item" style="" height="25">
														  ...
														  <?php  if ($extraflag=="sd"){ $data="data"; } else { $data=""; } ?>
														   ...
														   <td class="listing-item" align="center">
															...
															<td class="listing-item" align="center"><?php if ($extraflag!="sd"){ ?><INPUT type='checkbox' name='CheckAll_<?=$k?>_<?=$j?>' id='CheckAll_<?=$k?>_<?=$j?>' onClick="selAll(<?=$k?>,<?=$j?>); <?php if ($extraflag=="sd"){ ?>setAllAccess(<?=$k?>,<?=$j?>);<? } ?>" <?=$selAll?> class="chkBox selAcc_<?=$k?>"  <?=$disableFld?>><? } ?></td>
