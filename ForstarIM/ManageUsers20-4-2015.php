												...
												<td colspan="4" align="left">
													<table width="20%" cellspacing="1" bgcolor="#999999" cellpadding="3" id="tblUser" name="tblUser">
														...
														<tr id="Row_<?=$p?>" class="whiteRow" align="center">
															...
															<td>
																<select id="role_<?=$p?>" onchange="xajax_addNewRow(document.getElementById('company_<?=$p?>').value,document.getElementById('unit_<?=$p?>').value,document.getElementById('department_<?=$p?>').value);" name="role_<?=$p?>">
																	<option value="0">--Select All--</option>
																	<?php
