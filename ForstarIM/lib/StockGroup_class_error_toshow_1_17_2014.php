...
class StockGroup
{
	...
	*****************************************************************/
	...
	{		
		...
		$qry = "select a.id, a.category_id, a.sub_category_id, a.basic_unit_id, b.name, c.name, d.name from (stock_group a, stock_category b) left join stock_subcategory c on a.sub_category_id=c.id left join m_stock_unit d on a.basic_unit_id=d.id";
