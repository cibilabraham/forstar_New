...
class DailyFrozenPackingList
{
	...
	*****************************************************************/
	...
	function DailyFrozenPackingList(&$databaseConnect)
	{
...
#Delete a Grade Rec
	...
	function addPhysicalStkdailyFrozenmainRMLot($selDate, $userId,$repackId,$unit,$processorId,$dfId,$repackedfrom,$rmlotid)
	{
	...
	function adddailyfrozenEntriesRMLot($mainId,$fish_id,$processcode_id, $freezing_stage, $frozencode_id, $mcpacking_id)
	{		
	...
	function updateDailyFrozenPackingGradeRMLot($gradeUpid,$thawGrdTotal,$thawGrdLsTotal,$repkdQty)
	{
	...
	function getGradeAllocQty($processId,$freezingStage,$frozenCode,$stkAllocateMCPkgId,$selectDate,$tillDate,$gradeId)
	{
		...
		$qry="select sum(tda.number_mc),sum(number_loose_slab) from t_purchaseorder_rm_entry te left join t_dailyfrozenpacking_allocate tda on te.id=tda.po_rm_id where processcode_id='$processId' and freezingstage_id='$freezingStage' and frozencode_id='$frozenCode' and tda.created_on>='$selectDate' and tda.created_on<='$tillDate' and mcpacking_id='$stkAllocateMCPkgId' and tda.grade_id='$gradeId'";
			//echo $qry;
	...
	function getGradeAllocQtyRmLot($processId,$freezingStage,$frozenCode,$stkAllocateMCPkgId,$selectDate,$tillDate,$gradeId,$rmlotid)
	{
		...
		$qry="select sum(tda.number_mc),sum(number_loose_slab) from t_purchaseorder_rm_entry te left join t_dailyfrozenpacking_allocate_rmlotid tda on te.id=tda.po_rm_id left join t_dailyfrozenpacking_po_rmlotid dfpor on dfpor.id= tda.po_entry_id where processcode_id='$processId' and freezingstage_id='$freezingStage' and frozencode_id='$frozenCode' and tda.created_on>='$selectDate' and tda.created_on<='$tillDate' and mcpacking_id='$stkAllocateMCPkgId' and tda.grade_id='$gradeId' and dfpor.rm_lot_id='$rmlotid'";
			//echo $qry;
