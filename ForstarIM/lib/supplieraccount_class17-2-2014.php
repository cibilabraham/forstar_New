...
Class SupplierAccount
{
	...
	*****************************************************************/
	...
	function fetchLandingCenterRecords($fromDate, $tillDate, $settlementDate, $dateSelectFrom)
	{
		$dateSelection = "";
	...
	function fetchSupplierRecords($fromDate, $tillDate, $landingCenterId, $settlementDate, $dateSelectFrom)
	{
		$dateSelection = "";
		if ($dateSelectFrom=='WCD') {
			$dateSelection = "a.select_date>='".$fromDate."' and a.select_date<='".$tillDate."'";
	...
	function fetchChallanRecords($fromDate, $tillDate, $landingCenterId, $selectSupplier, $settlementDate, $dateSelectFrom, $billingCompany)
	{
		$dateSelection = "";
		if ($dateSelectFrom=='WCD') {
			$dateSelection = "a.select_date>='".$fromDate."' and a.select_date<='".$tillDate."'";
	...
	function fetchFishRecords($fromDate, $tillDate, $landingCenterId, $selectSupplier, $selChallanNo, $settlementDate, $dateSelectFrom, $billingCompany)
	{
		$dateSelection = "";
		if ($dateSelectFrom=='WCD') {
			$dateSelection = "a.select_date>='".$fromDate."' and a.select_date<='".$tillDate."'";
	...
	function getProcessCodeRecords($fromDate, $tillDate, $landingCenterId, $selectSupplier, $selChallanNo, $fishId, $settlementDate, $dateSelectFrom, $billingCompany)
	{
		$dateSelection = "";
		if ($dateSelectFrom=='WCD') {
			$dateSelection = "a.select_date>='".$fromDate."' and a.select_date<='".$tillDate."'";
