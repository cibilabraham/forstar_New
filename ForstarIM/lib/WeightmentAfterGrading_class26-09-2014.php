...
{  
	...
	function addWeightAfterGrading($rmLotId, $supplier,$pondName, $total, $effectiveWeight,$userId)
	{
		$qry	= "insert into t_rmweightaftergrading(rmLotId,supplier_name,pond_name,sumtotal,totalweight,created_on, created_by) values('$rmLotId','$supplier','$pondName','$total','$effectiveWeight', Now(),'$userId')";
	...
	{
 	 $qry	= "insert into t_rmweightaftergradingdetails(weightment_grading_id,fish_id,process_code_id,count_code,gradeID,weight,lotid_available,created_on, created_by) 
				   values('$lastId','$fish_id','$process_code_id','$count_code','$grandsingle','$weightsingle','$lotidStatus', Now(),'$userId')";
		// echo $qry;die;
