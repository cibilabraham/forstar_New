...
{
	/****************************************************************
	This class deals with all the operations relating to Distributor Wise Report
	*****************************************************************/
	var $databaseConnect;
	
	//Constructor, which will create a db instance for this class
	function DistributorReport(&$databaseConnect)
    	{
	...
	{	
		/*
		$qry = "select daci.invoice_id, tso.so from t_distributor_ac dac join t_distributor_ac_invoice daci on dac.id=daci.dist_ac_id join t_salesorder tso on tso.id=daci.invoice_id where dac.select_date>='$fromDate' and dac.select_date<='$tillDate' and dac.distributor_id='$selDistributorId' group by daci.invoice_id";
		*/
	...
	function dailyACStatmentRecs($fromDate, $tillDate, $distributorFilterId)
	{		
