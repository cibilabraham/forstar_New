...
{  
	...
	*****************************************************************/
	...
	function ProductionHoldingCost(&$databaseConnect)
    {	
	...
	{
		$qry = "select id,diesel_consumption_boiler,diesel_cost_litre,electric_consumption_day,electric_cost_unit,water_consumption_retort_batch,general_water_consumption_day,cost_per_litre_water,gas_per_cyldr_per_day,cost_of_cyldr from m_production_fuel_price order by id";
		//echo $qry;
		return $this->databaseConnect->getRecord($qry);
	}

	function updateProductionOtherCost($holdingCost,$holdingDuration,$adminOverheadChargesCode,$adminOverheadChargesCost,$profitMargin,$insuranceCost,$vatCode1,$vatRate1,$vatCode2,$vatRate2,$vatCode3,$vatRate3,$vatCode4,$vatRate4, $vatCode5,$vatRate5,$cstRate,$educationCess,$exciseRate,$pickle,$userId)
	{
		$qry="update m_production_holding_cost set holding_cost='$holdingCost',holding_duration='$holdingDuration',adn_overhd_charge_code='$adminOverheadChargesCode',	adn_overhd_charge_cost='$adminOverheadChargesCost',profit_margin='$profitMargin',insurance_cost='$insuranceCost',vat_code1='$vatCode1',vat_rate1='$vatRate1',,vat_code2='$vatCode2',vat_rate2='$vatRate2',,vat_code3='$vatCode3',vat_rate3='$vatRate3',vat_code4='$vatCode4',vat_rate4='$vatRate4',vat_code5='$vatCode5',cst_rate='$cstRate',education_cess='$educationCess',vat_rate1='$vatRate1',,vat_code1='$vatCode1',vat_rate1='$vatRate1',cost_of_cyldr='$costOfCylinder',createdon=Now(),createdby='$userId' where id='1'";
		//echo $qry;
		//die();
