...
{  
	...
	*****************************************************************/
	...
	#Add
	function addPackingCostMaster($vatRateForPackingMaterial, $innerCartonWstage, $costOfGum, $noOfMcsPerTapeRoll, $costOfTapeRoll, $tapeCostPerMc, $plcRateList, $pscRateList, $pmcRateList, $selRateList,$tempIncreaseFactor,$shrinkFilm,$ratePerGlassBottle,$ratePerBottle,$ratePerRetortPouch,$sealingCostGlassBottles,$sealingCost,$sealingCostPetBottles,$loadingCharges,$transportCostNSWE,$transportCostNE)
	{
		$qry = "insert into m_packing_cost (vat_rate, inner_carton_wstage, cost_of_gum,num_of_mc_per_tape_roll, cost_of_tape_roll, tape_cost_per_mc, plc_rate_list_id, psc_rate_list_id, pmc_rate_list_id, rate_list_id,temp_increase_factor,shrink_film,rate_per_glass_bottle,rate_per_bottle,rate_per_retort_pouch,sealing_cost_glass_bottles,sealing_cost,sealing_cost_pet_bottles,loading_charges,transport_cost_NSWE,transport_cost_NE) values('$vatRateForPackingMaterial', '$innerCartonWstage', '$costOfGum', '$noOfMcsPerTapeRoll', '$costOfTapeRoll', '$tapeCostPerMc',' $plcRateList', '$pscRateList','$pmcRateList', '$selRateList','$tempIncreaseFactor','$shrinkFilm','$ratePerGlassBottle','$ratePerBottle','$ratePerRetortPouch','$sealingCostGlassBottles','$sealingCost','$sealingCostPetBottles','$loadingCharges','$transportCostNSWE','$transportCostNE')";
		//echo $qry;
		//die();
	...
	{
		$qry = "select id, vat_rate, inner_carton_wstage, cost_of_gum, num_of_mc_per_tape_roll, cost_of_tape_roll, tape_cost_per_mc, plc_rate_list_id, psc_rate_list_id, pmc_rate_list_id, rate_list_id,temp_increase_factor,shrink_film,rate_per_glass_bottle,rate_per_bottle,rate_per_retort_pouch,sealing_cost_glass_bottles	,sealing_cost,sealing_cost_pet_bottles,loading_charges from m_packing_cost where rate_list_id='$selRateList' and  id is not null ";
		//echo $qry;
		return $this->databaseConnect->getRecord($qry);
	}

	# Update 
	function updatePackingCostMaster($packingCostMasterId, $vatRateForPackingMaterial, $innerCartonWstage, $costOfGum, $noOfMcsPerTapeRoll, $costOfTapeRoll, $tapeCostPerMc, $plcRateList, $pscRateList, $pmcRateList, $selRateList,$tempIncreaseFactor,$shrinkFilm,$ratePerGlassBottle,$ratePerBottle,$ratePerRetortPouch,$sealingCostGlassBottles,$sealingCost,$sealingCostPetBottles,$loadingCharges,$transportCostNSWE,$transportCostNE)
	{
		$qry =	" update m_packing_cost set vat_rate='$vatRateForPackingMaterial', inner_carton_wstage='$innerCartonWstage', cost_of_gum='$costOfGum', num_of_mc_per_tape_roll='$noOfMcsPerTapeRoll', cost_of_tape_roll='$costOfTapeRoll', tape_cost_per_mc='$tapeCostPerMc', plc_rate_list_id='$plcRateList', psc_rate_list_id='$pscRateList', pmc_rate_list_id='$pmcRateList', rate_list_id='$selRateList',temp_increase_factor='$tempIncreaseFactor',shrink_film='$shrinkFilm',rate_per_glass_bottle='$ratePerGlassBottle',rate_per_bottle='$ratePerBottle',rate_per_retort_pouch='$ratePerRetortPouch',sealing_cost_glass_bottles='$sealingCostGlassBottles',sealing_cost='$sealingCost',sealing_cost_pet_bottles='$sealingCostPetBottles',loading_charges='$loadingCharges',transport_cost_NSWE='$transportCostNSWE',transport_cost_NE='$transportCostNE'  where id=$packingCostMasterId";
		//echo $qry;
