...
$xajax->configure('statusMessages', true);
	...
	*/
	...
	function rmProcurmentSupplierName($supplierGroupId,$selSupplierGroupId)
	{
	...
	function rmProcurmentSupplierAddress($supplierNameId)
	{
	...
	function rmProcurmentPondAddress($pondNameId)
	{
		...
		$objResponse->assign("pondAddress", "value", "$pondAddressRecs");
