...
{  
	...
	*****************************************************************/
	...
	function ProductionWorkingHours(&$databaseConnect)
    {	
	...
	{
		$qry = "select * from m_production_working_hours order by id desc";
		//echo $qry;
		return $this->databaseConnect->getRecord($qry);
	}


	function addWorkingHours($noOfHoursShift,$noOfShift,$noOfGravyCookers,$noOfRetorts,$noOfSealingMachines,$noOfPouchesSealedPerminute,$noOfMinutesForSealing,$noOfDaysInYear,$noOfWorkingDaysInMonth,$noOfHoursPerDay,$noOfMinutesPerHour,$userId)
	{
		$qry = "insert into m_production_working_hours (no_of_hours_shift, no_of_shifts, no_of_gravy_cookers, no_of_retorts, no_of_sealing_machines, no_of_pouches_sealed, no_of_minutes_for_sealing, no_of_days_in_year, no_of_working_days_in_month	, no_of_hours, no_of_minutes_per_hour, created_on, created_by) values('$noOfHoursShift', '$noOfShift', $noOfGravyCookers, $noOfRetorts, $noOfSealingMachines, $noOfPouchesSealedPerminute, $noOfMinutesForSealing, $noOfDaysInYear, $noOfWorkingDaysInMonth, $noOfHoursPerDay, $noOfMinutesPerHour, NOW(), '$userId')";
		//echo $qry;
	...
	function updateWorkingHours($hidProductionWorkingHoursId,$noOfHoursShift,$noOfShift,$noOfGravyCookers,$noOfRetorts,$noOfSealingMachines,$noOfPouchesSealedPerminute,$noOfMinutesForSealing,$noOfDaysInYear,$noOfWorkingDaysInMonth,$noOfHoursPerDay,$noOfMinutesPerHour,$userId)
	{
		$qry="update m_production_working_hours set no_of_hours_shift='$noOfHoursShift',no_of_shifts='$noOfShift',no_of_gravy_cookers='$noOfGravyCookers',no_of_retorts='$noOfRetorts',no_of_sealing_machines='$noOfSealingMachines',no_of_pouches_sealed='$noOfPouchesSealedPerminute',no_of_minutes_for_sealing='$noOfMinutesForSealing',no_of_days_in_year='$noOfDaysInYear',no_of_working_days_in_month='$noOfWorkingDaysInMonth',no_of_hours='$noOfHoursPerDay',no_of_minutes_per_hour='$noOfMinutesPerHour',created_on=Now(),created_by='$userId' where id='$hidProductionWorkingHoursId'";
