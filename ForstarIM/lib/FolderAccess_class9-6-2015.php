...
class FolderAccess
{
	...
	*****************************************************************/
	...
	{
		//echo $supplierdtflg;
		$qry	=	"insert into access_folder ( module_id, function_id, access,submodule_id) values('$selModule', '$selFunction', '$selAccess', '$selSubModule')";
		//echo "--------------$qry";
		//die();
	...
	{
		$qry	= "select id,module_id, function_id, access from access_folder where module_id='$moduleId' and (function_id='$functionId' or function_id='0') and submodule_id='$subModuleId'";
		//echo $qry."<br>";
