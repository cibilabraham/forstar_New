...
{  
	...
	*****************************************************************/
	...
	function addPurchaseEntries($lastId, $stockId, $unitPrice, $quantity, $totalQty,$proddesc,$printoutdesc,$notover,$plant_unit_id,$excise,$excisePercentage,$vat,$vatPercentage)
	{
		$qry	=	"insert into purchaseorder_entry (po_id, stock_id, unit_price, quantity, total_amount,notover,proddescription,printoutdescrip,plant_unit_id,excise,excise_rate,vat,vat_rate) values('$lastId', '$stockId', '$unitPrice', '$quantity', '$totalQty','$notover','$proddesc','$printoutdesc','$plant_unit_id','$excise','$excisePercentage','$vat','$vatPercentage')";
		//echo $qry;
	...
	function fetchAllStockItem($editPurchaseOrderId, $poItem)
	{
		if ($poItem) {
			...
			$qry	=	"select id, po_id, stock_id, unit_price, quantity, total_amount,proddescription,printoutdescrip,notover,plant_unit_id, excise,excise_rate,vat,vat_rate from purchaseorder_entry where po_id='$editPurchaseOrderId' ";
		}		
	//echo $qry;
		$result	=	array();
		$result	=	$this->databaseConnect->getRecords($qry);
