<?php
class DistributorMarginStructure
{
	/****************************************************************
	...
	*****************************************************************/
	...
	function DistributorMarginStructure(&$DatabaseConnect_taskmgmt)
	{
        	$this->databaseConnect =&$DatabaseConnect_taskmgmt;
	}
	...
	function getDistMarginPagingRecords($offset, $limit, $distributorFilterId, $distributorRateListFilterId,$srchName)
	{		
		//echo($srchName);
	...
	*/
	...
	# Returns all Records
	function fetchAllRecords($distributorFilterId, $distributorRateListFilterId,$srchName)
	{
		//echo($srchName);
	...
	*/
	...
	function commaSepAreaList($selDistributor, $selStateId, $selCityId)
	{
		$qry = " select  e.id, e.name, d.area_id
			...
			and  if(d.area_id=0, c.city_id=e.city_id,d.area_id=e.id) and
			a.id='$selDistributor' and b.state_id='$selStateId' and c.city_id='$selCityId' order by e.name asc ";
		$getRecords = $this->databaseConnect->getRecords($qry);
