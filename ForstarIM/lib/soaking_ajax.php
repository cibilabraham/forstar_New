...
require_once("Soaking_class.php");
...
$xajax = new xajax();	
	...
	# Check Entry Exist
	function chkEntryExist($rmlotId,$fishId, $selectDate, $soakingId, $mode, $filterDate,$processCode)
	{
		...
		if ($fishId!="" && $selPreProcessDate!="") {
			# Check entry exist
			$entryExist	= $soakingObj->chkDuplicateEntryExist($rmlotId,$fishId, $selPreProcessDate, $soakingId,$processCode);
