...
class StockField
{
	...
	*****************************************************************/
	...
	{	
		...
		$qry = "select a.id, a.label_name, a.field_type, a.field_name, a.field_default_value, a.field_size, a.field_data_type, a.unit_group_id, b.name from stock_field a left join m_unit_group b on b.id=a.unit_group_id ";
