...
{  
	...
	*****************************************************************/
	...
	function getPurchaseOrderDescrption($catId,$subcatId,$stock_main_id)
	{
		...
		//$qry="select field_value from stock_group a  left join stock_group_entry b on a.id=b.main_id left join m_stock_stkg_entry c on b.id=c.stk_group_entry_id where a.category_id=$catId and a.sub_category_id=$subcatId and b.stk_field_id=15";
