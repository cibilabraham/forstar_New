...
{  
	...
	*****************************************************************/
	...
	{
		$qry	= "select a.id,a.company,a.procurement_number,a.date_of_entry,a.schedule_date,b.name from t_rmprocurmentorder a left join m_billing_company b on a.company=b.id  where a.id=$orderId";
				...
				$results	=	$this->databaseConnect->getRecords($query);
					...
					if(sizeof($results) >0)
					{
						...
						//$returnDay=$results[0][4]+1;
							...
							//echo $freedate.','.$allotDt.','.$schedule_date;
