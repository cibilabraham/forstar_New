...
{  
	...
	*****************************************************************/
	...
	function ProductionAdvertisement(&$databaseConnect)
    {	
        	$this->databaseConnect =&$databaseConnect;
	}

	function getProductionAdvertisement()
	{
		$qry = "select id,advt_cost_per_month,advt_cost_per_year from m_production_advertisement order by id";
		//echo $qry;
		return $this->databaseConnect->getRecord($qry);
	}

	function addProductionAdvertisement($advtCostPerMonth,$advtCostPerYear,$userId)
	{
		$qry = "insert into m_production_advertisement (advt_cost_per_month,advt_cost_per_year,created_on,created_by ) values('$advtCostPerMonth','$advtCostPerYear',Now(),'$userId' )";
		//echo $qry;
		//die();
	...
	function updateProductionAdvertisement($advtCostId,$advtCostPerMonth,$advtCostPerYear,$userId)
	{
		$qry="update m_production_advertisement set advt_cost_per_month='$advtCostPerMonth',advt_cost_per_year='$advtCostPerYear',created_on=Now(),created_by='$userId' where id='$advtCostId' ";
		//echo $qry;
		//die();
