...
{  
	...
	*****************************************************************/
	...
	function fetchAllPagingRecords($offset, $limit, $selRateList, $selProductCategoryId, $selProductStateId, $selProductGroupId)
	{
	...
	# Returns all Records
	function fetchAllRecords($selRateList, $selProductCategoryId, $selProductStateId, $selProductGroupId)
	{
		$whr = " a.product_id=b.id and a.rate_list_id='$selRateList' ";
