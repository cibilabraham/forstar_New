	...
	*****************************************************************/
	...
	function getWeightmentData($rmlotid,$phtCerificate)
	{
		...
		if(sizeof($res)>0)
		{
			...
			{
				$result.="<tr bgcolor='#e8edff'><td><input type='checkbox' class='chkBox' value='".$weighment[0]."' id='weightmentId_".$i."' name='weightmentId_".$i."' onclick='alloteData(".$i.");'>
				...
				<td class='listing-item' nowrap id='balanceQty_".$i."'>$weighment[7]</td><input type='hidden' name='hideAdjustedQty_".$i."' id='hideAdjustedQty_".$i."' size='15'><input  type='hidden' name='hideBalanceQty_".$i."' id='hideBalanceQty_".$i."' size='15'><input type='hidden' name='hidePhtCertifyQty_".$i."' id='hidePhtCertifyQty_".$i."' size='15'></tr>";
				$i++;
			}
			$result.="</table></td></tr>";
			//foreach($res as $weighment)
	...
	function getWeightmentDataRMLotID($rmlotid)
	{
		...
		if(sizeof($res)>0)
		{
			...
			foreach($res as $weighment)
			{
				...
				<td class='listing-item' nowrap>$weighment[11]</td>
				<td class='listing-item' nowrap>$weighment[6]</td>
				<td class='listing-item' nowrap id='supplyQty_".$i."'>$weighment[7]</td><td class='listing-item' nowrap><select name='certificateNo_".$i."' id='certificateNo_".$i."' onchange='xajax_certificateAvailableQty(this.value,".$i.",".$weighment[0].");'>";
					$result.="<option value=''> --Select-- </option>";
					foreach($rest as $cerificateDetail)
					{	
						$result.="<option value='".$cerificateDetail[0]."'>".$cerificateDetail[1]."</option>";
					}

					$result.= "</select>";
					$result.="</td><td class='listing-item' nowrap><input name='availableQtySupplier_".$i."' id='availableQtySupplier_".$i."' size='15' /></td><td class='listing-item' nowrap><input name='adjustedQtySupplier_".$i."' id='adjustedQtySupplier_".$i."' size='15' /><input type='hidden' name='balanceQtySupplier_".$i."' id='balanceQtySupplier_".$i."' size='15' /><input type='hidden' name='weightmentSupplier_".$i."' id='weightmentSupplier_".$i."' size='15' value='$weighment[0]'/></td></tr>";
				$i++;
			}
			//foreach($res as $weighment)
			//{
