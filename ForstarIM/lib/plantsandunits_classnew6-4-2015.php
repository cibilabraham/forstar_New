...
{  
	...
	*****************************************************************/
	...
	# Insert
	function addPlant($company,$no, $name,$stdProduction,$basedOn)
	{
		$qry	=	"insert into m_plant (no,company_id,name,standard_production,based_on) values('".$no."','".$company."','".$name."','".$stdProduction."','".$basedOn."')";
		//echo $qry;
		//die();
	...
	{
		$qry	=	"select id, no,company_id, name,standard_production,based_on from m_plant where id=$plantId";
	...
	# Update Plant
	function updatePlant($plantId,$company, $no, $name,$stdProduction,$basedOn)
	{
		$qry	=	" update m_plant set company_id='$company',no='$no', name='$name',standard_production='$stdProduction',based_on='$basedOn' where id=$plantId";
		//echo $qry;
