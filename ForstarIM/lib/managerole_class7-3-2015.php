...
$qry	=	"insert into role_function (role_id, module_id, function_id,submodule_id,supplierdtflg) values('$lastInsertedId','$selModule','$selFunction','$selSubModule','$supStatus')";
	...
	{
		$qry	= "select * from ((select b.id as function_id, b.name as functionname, b.module_id as module_id, b.url as url, b.form_add as form_add, b.form_edit as form_edit, b.form_delete as form_delete, b.form_print as form_print, b.form_confirm as form_confirm, b.form_reedit as form_reedit, b.pmenu_id as pmenu_id, c.name as name, b.frm_cpny_specific as frm_cpny_specific ,b.extraflag as extraflag,a.supplierdtflg as supplierdtflg from access_folder a left join function b on (a.function_id=b.id or a.function_id='0') left join module c on (b.module_id=c.id) where a.module_id=b.module_id and a.submodule_id=0 and pmenu_id is null)  
		union  
		(select b.id as function_id, b.name as functionname, b.module_id as module_id, b.url as url, b.form_add as form_add, b.form_edit as form_edit, b.form_delete as form_delete, b.form_print as form_print, b.form_confirm as form_confirm, b.form_reedit as form_reedit, b.pmenu_id as pmenu_id, c.name as name, b.frm_cpny_specific as frm_cpny_specific ,b.extraflag as extraflag,a.supplierdtflg as supplierdtflg from access_folder a left join function b on (a.function_id=b.id or a.function_id='0') left join module c on (b.module_id=c.id) where  (a.module_id=b.module_id) and (a.submodule_id=b.pmenu_id) ))dum  group by module_id,pmenu_id,function_id,supplierdtflg order by module_id,pmenu_id,url,function_id";
		//$qry	= "select b.id, b.name, b.module_id, b.url, b.form_add, b.form_edit, b.form_delete, b.form_print, b.form_confirm, b.form_reedit, b.pmenu_id, c.name, b.frm_cpny_specific,b.extraflag,a.supplierdtflg from access_folder a left join function b on (a.function_id=b.id or a.function_id='0') left join module c on (b.module_id=c.id) where a.module_id=b.module_id and a.submodule_id=b.pmenu_id order by b.module_id,b.pmenu_id,b.url,b.id";
		
		//$qry	= "select b.id, b.name, b.module_id, b.url, b.form_add, b.form_edit, b.form_delete, b.form_print, 
		.b.form_confirm, b.form_reedit, b.pmenu_id, c.name, b.frm_cpny_specific,b.extraflag from access_folder a left join function b on (a.function_id=b.id or a.function_id='0') left join module c on (b.module_id=c.id) where a.module_id=b.module_id and a.submodule_id=b.pmenu_id  group by b.module_id,b.pmenu_id,b.id order by b.module_id ,b.pmenu_id ,b.id ";
		
		//$qry	= "select b.id, b.name, b.module_id, b.url, b.form_add, b.form_edit, b.form_delete, b.form_print, b.form_confirm, b.form_reedit, b.pmenu_id, c.name, b.frm_cpny_specific,b.extraflag from access_folder a  left join function b on (a.function_id=b.id or a.function_id='0') left join module c on (b.module_id=c.id) where a.module_id=b.module_id and a.submodule_id=b.pmenu_id "; 
