...
#Manage Recipe Category
 ...
 # Manage Carriage Mode Master
  ...
  # Manage Gst Master
  #-----------------------------------------------------------------
  $msg_failAddGstMaster	=     	" Failed to add GST percentage.";
  $msg_succAddGstMaster	=	" GST percentage added successfully.";
  $msg_succDelGstMaster	=	"GST deleted successfully.";
  $msg_failDelgstMaster	=	" Failed to delete the GST.";
  $msg_succgstUpdate	=	" Updated GST successfully.";
  $msg_failgstMasterUpdate	=	" Failed to update the GST.";

  $url_afterAddGstMaster		=	"GstMaster.php";
  $url_afterDelGstMaster		=	"GstMaster.php";
  $url_afterUpdateGstMaster	=	"GstMaster.php";

  $label_editgstaster	=	" Edit a GST ";
  //$msgFailAddExciseDutyExistRec	= " Please make sure the state wise product category wise excise duty not existing.";
  ...
  # Manage IGst Master
  #-----------------------------------------------------------------
  $msg_failAddIGstMaster	=     	" Failed to add IGST percentage.";
  $msg_succAddIGstMaster	=	" IGST percentage added successfully.";
  $msg_succDelIGstMaster	=	"IGST deleted successfully.";
  $msg_failDelIgstMaster	=	" Failed to delete the IGST.";
  $msg_succigstUpdate	=	" Updated IGST successfully.";
  $msg_failIgstMasterUpdate	=	" Failed to update the IGST.";

  $url_afterAddIGstMaster		=	"IgstMaster.php";
  $url_afterDelIGstMaster		=	"IgstMaster.php";
  $url_afterUpdateIGstMaster	=	"IgstMaster.php";

  $label_editIgstaster	=	" Edit a IGST ";
  //$msgFailAddExciseDutyExistRec	= " Please make sure the state wise product category wise excise duty not existing.";
...
$msg_succConfirmgst="Confirmed GST Successfully";
$msg_succConfirmigst="Confirmed IGST Successfully";

$msg_succRelConfirmexciseDuty="Released Confirmation of ExDuty Successfully";
$msg_succRelConfirmgst="Released Confirmation of GST Successfully";
$msg_succRelConfirmigst="Released Confirmation of IGST Successfully";
