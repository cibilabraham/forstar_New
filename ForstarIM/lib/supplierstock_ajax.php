...
require_once("libjs/xajax_core/xajax.inc.php");
	...
	function getCompanyUnit($stockId)
	{
		...
		$stockRec	= $stockObj->find($stockId);
		...
		if($stockType=='P')
		{
			$dispLayer=$supplierstockObj->displayLayer($layer);
			//$objResponse->alert($dispLayer);
			$objResponse->assign("layerDisp", "innerHTML", $dispLayer);
		}

		$objResponse->assign("hidUnitName", "value", $unitName);
		$objResponse->assign("stockType", "value", $stockType);
		return $objResponse;
	}
