...
class FrozenPackRating
{
	...
	*****************************************************************/
	...
	function addSelGradeRec($ratingId,$entryId, $gradeId,$userId)
	{
		$qry	 = "insert into m_frzn_pkg_rate_grade (rating_id,pkg_rate_entry_id, grade_id,created_by) values('$ratingId','$entryId', '$gradeId','$userId')";
		//echo $qry.'<br/>';
		$insertStatus	= $this->databaseConnect->insertRecord($qry);
		if ($insertStatus) $this->databaseConnect->commit();
		else $this->databaseConnect->rollback();
	...
	*/
	...
	# get Grade Recs
	function getGradeRate($processCodeId,$fishId,$rowId,$rateTag,$editGradeValue)
	{
		$table="";
																...
																<table cellpadding="0" cellspacing="0">
																	<tr>
																		...
																		<td nowrap style="padding-left:10px;">
																			<input type="button" name="cmdAddExptRate" id="cmdAddExptRate" value="Save" onclick="addGrade('.$rowId.','.$processCodeId.','.$fishId.');" style=" font-size:11px;"/>
														...
														$table.='<tr>
															<TD valign="top">
																<table>
																	<tr>
																		<TD align="right">
																		<input type="button" name="cmdDelete" value="Delete" style="text-align:right; font-size:11px;" onclick="getGrades('.$processCodeId.','.$fishId.','.$rowId.');" />
																		</TD>
																	</tr>
																	<TR>
																		<TD>
																		...
																		$table.='<TR>
																				...
																				<td>
																					<input type="submit" name="cmdEdit" value="Edit" onClick="editGrade('.$processCodeId.','.$fishId.','.$rowId.','.$editgrades.');" style="text-align:right; font-size:11px;"/>
																				</td>
																			</TR>';
																		}
																	$table.='</tbody>
