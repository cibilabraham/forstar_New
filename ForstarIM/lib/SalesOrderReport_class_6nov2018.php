...
class SalesOrderReport
{
	...
	*****************************************************************/
	...
	function fetchSalesOrderRecords($fromDate, $tillDate, $invoiceType, $reportType, $selTransporter, $selDistributorId, $selState, $selCityIds, $selStatus, $dateSelFrom)
	{
		...
		$qry	= "select a.id, a.so, a.distributor_id, a.invoice_date, a.dispatch_date, a.state_id, a.grand_total_amt, a.city_id, a.net_wt, a.gross_wt, a.num_box, a.transporter_id, a.docket_no, b.name, c.name, d.name, a.complete_status, ROUND((a.grand_total_amt+a.round_value),2), a.last_date, a.extended, a.invoice_type, a.proforma_no, a.sample_invoice_no, a.pkng_confirm, a.gpass_confirm, a.delivery_date, a.delivery_remarks from t_salesorder a, m_distributor b, m_state c, m_city d ";
