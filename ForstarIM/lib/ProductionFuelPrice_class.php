...
{  
	...
	*****************************************************************/
	...
	function ProductionFuelPrice(&$databaseConnect)
    {	
        	$this->databaseConnect =&$databaseConnect;
	}

	function getProductionFuelPrice()
	{
		$qry = "select id,diesel_rate_per_unit,diesel_consumption_batch,electricity_rate_per_unit,electricity_consumption_per_day,waterprocessing_rate_per_unit,waterprocessing_consumption_batch,watergeneral_rate_per_unit,watergeneral_consumption_per_day,gas_rate_per_unit,gas_per_day from m_production_fuel_price order by id";
		//echo $qry;
		return $this->databaseConnect->getRecord($qry);
	}

	function addProductionFuelPrice($dieselRatePerUnit,$dieselConsumptionBatch,$electricityRatePerUnit, $electricityConsumptionPerDay,$waterProcessingRatePerUnit,$waterProcessingConsumptionBatch,$waterGeneralRatePerUnit,$waterGeneralConsumptionPerDay,$gasRatePerUnit,$gasPerDay,$userId)
	{
		
		$qry = "insert into m_production_fuel_price (diesel_rate_per_unit, diesel_consumption_batch, electricity_rate_per_unit,electricity_consumption_per_day, waterprocessing_rate_per_unit, waterprocessing_consumption_batch, watergeneral_rate_per_unit, watergeneral_consumption_per_day, gas_rate_per_unit, gas_per_day,created_on,created_by) values('$dieselRatePerUnit', '$dieselConsumptionBatch', '$electricityRatePerUnit', '$electricityConsumptionPerDay', '$waterProcessingRatePerUnit', '$waterProcessingConsumptionBatch',' $waterGeneralRatePerUnit', '$waterGeneralConsumptionPerDay','$gasRatePerUnit', '$gasPerDay',Now(),'$userId')";
		//echo $qry;
		//die();
	...
	function updateProductionFuelPrice($productionFuelId,$dieselRatePerUnit,$dieselConsumptionBatch,$electricityRatePerUnit, $electricityConsumptionPerDay,$waterProcessingRatePerUnit,$waterProcessingConsumptionBatch,$waterGeneralRatePerUnit,$waterGeneralConsumptionPerDay,$gasRatePerUnit,$gasPerDay,$userId)
	{
		$qry="update m_production_fuel_price set diesel_rate_per_unit='$dieselRatePerUnit',diesel_consumption_batch='$dieselConsumptionBatch',electricity_rate_per_unit='$electricityRatePerUnit',	electricity_consumption_per_day='$electricityConsumptionPerDay',
		waterprocessing_rate_per_unit='$waterProcessingRatePerUnit',waterprocessing_consumption_batch='$waterProcessingConsumptionBatch',watergeneral_rate_per_unit='$waterGeneralRatePerUnit',watergeneral_consumption_per_day='$waterGeneralConsumptionPerDay',gas_rate_per_unit='$gasRatePerUnit',	gas_per_day='$gasPerDay',created_on=Now(),created_by='$userId' where id='$productionFuelId'";
		//echo $qry;
		//die();
