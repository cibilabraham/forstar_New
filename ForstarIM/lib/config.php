<?php
	...
	**/
	...
	# Id Gen Functions
	//old
	//$idGenFunctions = array("1"=>"-----Procurement-----", "MG"=>"Procurment Number ID", "RM"=>"Raw Material", "LF"=>"RM LOT ID","WC"=>"Weighment Data Sheet","SL"=>"Seal Number","RG"=>"Receipt Gate Pass Number","2"=>"-----Shipment-----", "DC"=>"Distributor Claim","SPO"=>"Shipment Invoice", "SHPC"=>"Container","PR"=>"Purchase Reference","3"=>"-----Inventory-----","PO"=>"Purchase Order", "SI"=>"Stock Issuance", "SR"=>"Stock Return","4"=>"-----Ingredient-----","IPO"=>"Ingredient PO","IGC"=>"Ingredient Code","5"=>"-----RTE-----","SO"=>"Sales Order","MGP"=>"Manage Gatepass");
	$idGenFunctions = array("1"=>"-----Procurement-----", "MG"=>"Procurment Number ID", "RM"=>"Raw Material", "LF"=>"RM LOT ID","WC"=>"Weighment Data Sheet","SL"=>"Seal Number","RG"=>"Receipt Gate Pass Number","2"=>"-----Shipment-----", "DC"=>"Distributor Claim","SPO"=>"Shipment Invoice", "SHPC"=>"Container","PR"=>"Purchase Reference","3"=>"-----Inventory-----","PO"=>"Purchase Order", "SI"=>"Stock Issuance", "SR"=>"Stock Return","4"=>"-----Ingredient-----","IPO"=>"Ingredient PO","IGC"=>"Ingredient Code","5"=>"-----RTE-----","SO"=>"Sales Order","GP"=>"Manage Gatepass");

	
	//$idGenFunctions = array("PO"=>"Purchase Order (Inventory)", "SI"=>"Stock Issuance", "SR"=>"Stock Return", "DC"=>"Distributor Claim", "IPO"=>"Ingredient PO", "SO"=>"Sales Order", "RM"=>"Raw Material", "SPO"=>"Shipment Invoice", "SHPC"=>"Container", "MG"=>"Procurment Number ID", "LF"=>"RM LOT ID","WC"=>"Weighment Data Sheet","SL"=>"Seal Number","RG"=>"Receipt Gate Pass Number","IGC"=>"Ingredient Code");
	...
	* Export Address
	*/
	$exportAddrArr = array("ADRH"=>"FORSTAR FROZEN FOODS PVT. LTD", "ADR1"=>"505 A, GALLERIA, HIRANANDANI GARDENS", "ADR2"=>"A. S. MARG, POWAI", "ADR3"=>"MUMBAI – 400 076 (INDIA)","ADR4"=>"TEL: (22) 2741 2376,","ADR5"=>"FAX: (22) 2741 0999","ADR6"=>"EMAIL: instafoods@forstarfoods.com");
	...
	*/
	...
	$forstinsfoods=array("fifoods"=>"FORSTAR INSTA FOODS");
	$forstinsfoods1=array("fifoods1"=>"FORSTAR INSTA FOODS PVT LTD"); /*KD Added*/
	$divfrfoods=array("frfoods"=>"(Div. of Forstar Frozen Foods Pvt Ltd)");
	$addr=array("ADR1"=>"M-52, MIDC Industrial Area, Taloja","ADR2"=>"Navi Mumbai - 410 208, Maharashtra, India","ADR3"=>"TEL: (22) 2741 2376,","ADR4"=>"FAX: (22) 2741 0999","ADR5"=>"EMAIL: instafoods@forstarfoods.com","ADR6"=>"PLOT NO. M-53, P.O.BOX.NO. 09,","ADR7"=>"NEW BOMBAY-410208 (INDIA)","ADR8"=>"EIC APPROVAL.NO.209","ADR9"=>"","ADR10"=>"","ADR11"=>"",);
	$companyArr=array("Name"=>"FORSTAR FROZEN FOODS PVT.LTD","Email"=>"EMAIL: instafoods@forstarfoods.com");
	$debitNoteArr = array("Name"=>"NAIR BROTHERS","ADDR1"=>"PLOT NO. M-53, MIDC Ind Area, Taloja New Bombay 410 208, India","CONTACT_NUMBER"=>"Tel: 022-27412376, 27410807, FAX: 022-27410999, CELL: 9820449554,9870688991","Email"=>"EMAIL: export@forstarfoods.com");
	/*
