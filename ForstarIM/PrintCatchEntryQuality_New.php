...
<form name="frmPrintCatchEntryQuality" action="PrintCatchEntryQuality_New.php" method="post">
  ...
  <tr>
	...
	<?
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td class="listing-item" nowrap align="right" style="padding-right:70px;"><?=$percent?></td>
      </tr>
