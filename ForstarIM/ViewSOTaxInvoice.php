<?php	
	...
	//echo "Original $soGrossWt====".$salesOrderObj->getActualPkgGrossWt($selSOId);
	...
	#  Number of Copy
	$numCopy	= 1; //3
	if ($invoiceConfirmed=='C') $confirmed = true;
?>
<html>
<head>
...
<table width="99%" cellpadding="2" cellspacing="0" bgcolor="#CCCCCC"  class="print">
	...
	<th class="p-listing-head" style="padding-left:3px; padding-right:3px;" nowrap="true" width="12%">TOTAL<br/>(RS.)</th>
      ...
      <?php
		...
		//echo number_format((9.04*1/100),4,'.','');
		foreach ($salesOrderItemRecs as $por) {
			...
			$totCentralTaxAmt = $por[20];	
			$total		= ($invoiceType=='T')?($por[5]+$totCentralTaxAmt):0;			
			$productName	= "";
...
<!-- Ends Here -->	
  ...
  <tr>
   ...
   ?>
	...
	?>	
	<tr>
		<td height='25' colspan="<?=$btmColSpan?>" nowrap="nowrap"  align="right">
			<table cellspacing='0' cellpadding='0' width="100%" class="tdBoarder">
				<tr>
	...
	<tr bgcolor="#FFFFFF">
		<td height='25' colspan="<?=$btmColSpan?>" nowrap="nowrap" align="left">
			<table cellspacing='0' cellpadding='0' width="100%" class="tdBoarder">
				<tr>
