			...
			<td class="listing-item" style="" height="25">
			  ...
			  <?php  if ($extraflag=="sd"){ $data="data"; } else { $data=""; } ?>
			   <input type="hidden" name="hidRoleFunctionId_<?=$k?>_<?=$j?>" value="<?=$roleFunctionId?>"></td>
                <td class="listing-item" align="center">
					<?php if ($extraflag!="sd"){ ?>
					<input name="selAccess_<?=$k?>_<?=$j?>" type="checkbox" id="selAccess_<?=$k?>_<?=$j?>" value="Y" <?=$selAccess?> class="chkBox <?=$data?>">
					<? } else { ?>
					<input name="selAccess_<?=$k?>_<?=$j?>" type="hidden" id="selAccess_<?=$k?>_<?=$j?>" value="Y" <?=$selAccess?> class="chkBox <?=$data?>" <?php  if ($extraflag=="sd"){?>  onclick="selAllSupplier(<?=$k?>,<?=$j?>);" <? } ?>>
					<? } 
					?>
				</td>
				<td class="listing-item" align="center">
					<?php if ($extraflag!="sd"){ ?>
					<input name="selAdd_<?=$k?>_<?=$j?>" type="<?=$displayAdd?>" id="selAdd_<?=$k?>_<?=$j?>" value="Y" <?=$selAdd?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox"> 
					<? }  else { ?>
					<input name="selAdd_<?=$k?>_<?=$j?>" type="hidden" id="selAdd_<?=$k?>_<?=$j?>" value="Y" <?=$selAdd?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox"> 
					<? } ?>
			   </td>
               <td class="listing-item" align="center">
					<?php if ($extraflag!="sd"){ ?>
					<input name="selEdit_<?=$k?>_<?=$j?>" type="<?=$displayEdit?>" id="selEdit_<?=$k?>_<?=$j?>" value="Y" <?=$selEdit?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox">
					<? } else { ?>
					<input name="selEdit_<?=$k?>_<?=$j?>" type="hidden" id="selEdit_<?=$k?>_<?=$j?>" value="Y" <?=$selEdit?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox">
					<? } ?>

				</td>
                <td class="listing-item" align="center">
					<?php if ($extraflag!="sd"){ ?>
					<input name="selDelete_<?=$k?>_<?=$j?>" type="<?=$displayDelete?>" id="selDelete_<?=$k?>_<?=$j?>" value="Y" <?=$selDelete?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox">
					<? }  else { ?>
					<input name="selDelete_<?=$k?>_<?=$j?>" type="hidden" id="selDelete_<?=$k?>_<?=$j?>" value="Y" <?=$selDelete?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox">
					<? } ?>

				</td>
                <td class="listing-item" align="center">
					<?php if ($extraflag!="sd"){ ?>
					<input name="selPrint_<?=$k?>_<?=$j?>" type="<?=$displayPrint?>" id="selPrint_<?=$k?>_<?=$j?>" value="Y" <?=$selPrint?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox">
					<? }  else { ?>
					<input name="selPrint_<?=$k?>_<?=$j?>" type="hidden" id="selPrint_<?=$k?>_<?=$j?>" value="Y" <?=$selPrint?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox">
					<? } ?>

				</td>
                <td class="listing-item" align="center">
					<?php if ($extraflag!="sd"){ ?>
					<input name="selConfirm_<?=$k?>_<?=$j?>" type="<?=$displayConfirm?>" id="selConfirm_<?=$k?>_<?=$j?>" value="Y" <?=$selConfirm?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox">
					<? }  else { ?>
					<input name="selConfirm_<?=$k?>_<?=$j?>" type="hidden" id="selConfirm_<?=$k?>_<?=$j?>" value="Y" <?=$selConfirm?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox">
					<? } ?>
				</td>
                <td class="listing-item" align="center">
					<?php if ($extraflag!="sd"){ ?>
					<input name="selReEdit_<?=$k?>_<?=$j?>" type="<?=$displayReEdit?>" id="selReEdit_<?=$k?>_<?=$j?>" value="Y" <?=$selReEdit?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox">
					<? }  else { ?>
					<input name="selReEdit_<?=$k?>_<?=$j?>" type="hidden" id="selReEdit_<?=$k?>_<?=$j?>" value="Y" <?=$selReEdit?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox">
					<? }?>
				</td>
			     <td class="listing-item" align="center">
					<?php if ($extraflag!="sd"){ ?>
					<input name="selCompanySpecific_<?=$k?>_<?=$j?>" type="checkbox" id="selCompanySpecific_<?=$k?>_<?=$j?>" value="Y" <?=$selCompanySpecific?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox">
					<? } else {?>
					<input name="selCompanySpecific_<?=$k?>_<?=$j?>" type="hidden" id="selCompanySpecific_<?=$k?>_<?=$j?>" value="Y" <?=$selCompanySpecific?> onclick="checkSel(<?=$k?>,<?=$j?>);" class="chkBox">
					<? } ?>
				 </td>
			    ...
			    <td class="listing-item" align="center"><?php if ($extraflag!="sd"){ ?><INPUT type='checkbox' name='CheckAll_<?=$k?>_<?=$j?>' id='CheckAll_<?=$k?>_<?=$j?>' onClick="selAll(<?=$k?>,<?=$j?>); <?php if ($extraflag=="sd"){ ?>setAllAccess(<?=$k?>,<?=$j?>);<? } ?>" <?=$selAll?> class="chkBox selAcc_<?=$k?>"  ><? } ?></td>
...
<td class="listing-item" align="center"><input name="selAccess1" type="checkbox" id="selAccess1" value="Y" <?=$selAccess1?> class="chkBox" onclick="chkData(<?=$k?>,<?=$j?>);"></td>
				...
				<tr bgcolor="#FFFFFF" id="invfrz2" style="display:none" >&nbsp;<td class="listing-item" style="padding-left:20px;" nowrap="nowrap">&nbsp;</td><td class="listing-item" style="padding-left:20px;" nowrap="nowrap">&nbsp;</td><td class="listing-item" style="padding-left:20px;" nowrap="nowrap"><input type="hidden" name="supdChkbx3" id="supdChkbx3" class="fsaChkbx" value="1" onclick="selAllinv(<?=$k?>,0);" <?=$flagRTEchecked;?> >Supplier Data-RTE &nbsp;</td><!--<td class="listing-head" align="center" bgcolor="#f2f2f2">&nbsp;&nbsp;All</td><td class="listing-head" align="center" bgcolor="#f2f2f2">&nbsp;Inventory</td><td class="listing-head" align="center" bgcolor="#f2f2f2">&nbsp;Frozen</td><td class="listing-head" align="center" bgcolor="#f2f2f2">&nbsp;RTE</td><td class="listing-head" align="center"bgcolor="#f2f2f2"><td class="listing-item" align="center" bgcolor="#f2f2f2">&nbsp;</td><td class="listing-item" align="center" bgcolor="#f2f2f2">&nbsp;</td><td class="listing-item" align="center" bgcolor="#f2f2f2">&nbsp;</td><td class="listing-item" align="center" bgcolor="#f2f2f2">&nbsp;</td>--><td class="listing-item" align="center"><input name="selAccess3" type="checkbox" id="selAccess3" value="Y" <?=$selAccess3?> class="chkBox" onclick="chkData(<?=$k?>,<?=$j?>);"></td>
