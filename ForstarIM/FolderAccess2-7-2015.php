												...
												<td colspan="2" nowrap align="center" style="padding-left:10px;padding-right:10px;">
													<table width="100%" cellpadding="0" cellspacing="1" bgcolor="#999999">
														...
														foreach ($getFunctionRecords as $gfr) {
															...
															//echo $flagInvchecked;
															...
															else {$selAccess1	=	""; $flagInvchecked="";}
																...
																if ($rrS[4]=="FRN")
																{
																if($rrS[3]=='Y')	{$selAccess2	= 	"Checked";

																$flagFRNchecked="Checked";
																}
																else {$selAccess2	=	""; $flagFRNchecked="";}

																$selAll2 = "";
																if ($rrS[3]=='Y' ) $selAll2 = "Checked";
																else $selAll2 = "";
																}
																if ($rrS[4]=="RTE")
																{
																if($rrS[3]=='Y'){	$selAccess3	= 	"Checked";
																 $flagRTEchecked="Checked";


																}
																else {$selAccess3	=	""; $flagFRNchecked="";}
																$selAll3 = "";
														...
														<tr bgcolor="#FFFFFF" id="<?=$k."_".$j?>" style="display:none"> 
														   ...
														   <td class="listing-item" style="padding-left:20px;" nowrap="nowrap">
															...
															<td class="listing-item" align="center"><?php  if ($extraflag!="sd"){?><input name="selAccess_<?=$k?>_<?=$j?>" type="checkbox" id="selAccess_<?=$k?>_<?=$j?>" <?=$disAccess?> value="Y" <?=$selAccess?> class="chkBox selAcc_<?=$k?>"   <? /*onclick="selAllinv(<?=$k?>,<?=$j?>);" */?> >
															<? } else { ?>
