<?php
	...
	if ($p["cmdAdd"]!="") {
		...
		if ($selIngredient!="" && $ingRatePerKg!="" && !$sameEntryExist) {
			...
			$ingredientRateRecIns = $ingredientRateMasterObj->addIngredientRate($selIngredient, $ingRatePerKg, $ingYield, $ingHighPrice, $ingLowPrice, $ingLastPrice, $ingRateList, $userId);
	...
	if ($p["cmdSaveChange"]!="") {		
		...
		if ($ingredientRateId!="" && $selIngredient!="" && $ingRatePerKg!="") {
			$ingredientRateRecUptd = $ingredientRateMasterObj->updateIngredientRate($ingredientRateId, $selIngredient, $ingRatePerKg, $ingYield, $ingHighPrice, $ingLowPrice, $ingLastPrice, $ingRateList);
		}
