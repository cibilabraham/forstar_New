			...
			<? if($print==true){?>				 
				...
				<? if($singleDay!=""){?>
                                  <tr> 
                                    ...
                                    <td><input name="selDate" type="text" id="selDate" size="8" value="<?=$selDate?>" onchange="this.form.submit();"></td>
                                  </tr>
				<? }?>
				<? if($dateRange!="") {?>
                                  <tr> 
                                    ...
                                    <td> 
                                      <? $dateFrom = $p["supplyFrom"];?>
                                      <input type="text" id="supplyFrom" name="supplyFrom" size="8" value="<?=$dateFrom?>" onchange="submitForm('supplyFrom','supplyTill',document.frmDailyCatchSummary);"></td>
                                  </tr>
                                  <tr> 
                                    <td class="fieldName"> Till:</td>
                                    <td> 
                                      <? $dateTill = $p["supplyTill"];?>
                                      <input type="text" id="supplyTill" name="supplyTill" size="8"  value="<?=$dateTill?>" onchange="submitForm('supplyFrom','supplyTill',document.frmDailyCatchSummary);"/></td>
                                  </tr>
				<? }?>
				<tr>
					<TD colspan="2">
	...
	?>
			...
			?>
				...
				<table width="200" border="0">
							  ...
							  <tr>
							  <td>
							  <fieldset><legend class="fieldName">Search Options</legend>
				...
				<? if ($dateSelectFrom=='WCD') {?>
				    ...
				    <td><table><TR><td class="listing-item" nowrap><input name="localQtyChk" type="checkbox" id="localQtyChk" value="LQC" <?=$localQtyChk?> class="chkBox" onclick="removeChkRate(document.frmDailyCatchSummary);enabrtAmount();"></td>
                                    <td class="listing-item" nowrap>Local Quantity </td></TR></table></td>
                                  </tr>
				 <?  }
				if ($dateSelectFrom=='SCD') {?>
                                  <tr>
				    ...
				    <td><table><TR><td class="listing-item" nowrap><input name="subSupplierChk" type="checkbox" id="subSupplierChk" value="SSC" <?=$subSupplierChk?> class="chkBox" onclick=""></td>
                                    <td class="listing-item" nowrap>Sub-Supplier </td></TR></table></td>
                                  </tr>
                                  <tr>
				...
				<!--<tr>
                                    <td><input name="supSetlmentSummary" type="checkbox" id="supSetlmentSummary" value="Y" <?=$supSetlmentSummaryChk?> onclick="removeAllChk(this.form,'supSetlmentSummary');" class="chkBox"></td>
                                    <td colspan="3" class="listing-item">Supplier Settlement Summary </td>
                                  </tr>-->
				<? }?>
                                 <!-- <tr>
                                    <td><input name="rateNAmount" type="checkbox" id="rateNAmount" value="RA" <?=$rateNAmountCheck?> class="chkBox" onclick="removeChkLocal(document.frmDailyCatchSummary);enabrtAmount();"></td>
                                    <td colspan="3" class="listing-item" align="left">Rate &amp; Amount </td>
                                  </tr>-->
				<? if ($dateSelectFrom=='WCD') {?>
                                  <tr>
				 ...
				 <!--tr>
                                    <td><input name="localQtyChk" type="checkbox" id="localQtyChk" value="LQC" <?=$localQtyChk?> class="chkBox" onclick="removeChkRate(document.frmDailyCatchSummary);"></td>
                                    <td colspan="3" class="listing-item">Local Quantity </td>
                                  </tr-->
				<tr>
...
<!--<tr height="30px"><td style="border-top:solid 1px;border-left:solid 1px;border-bottom:solid 1px;padding:0px;"><input name="rateNAmount" type="checkbox" id="rateNAmount" value="RA" <?=$rateNAmountCheck?> class="chkBox" onclick="removeChkLocal(document.frmDailyCatchSummary);enabrtAmount();" ></td>
                                    <td colspan="3" class="listing-item" align="left" style="border-top:solid 1px;border-bottom:solid 1px;border-right:solid 1px;">Rate &amp; Amount</td></tr>
...
<tr><td>
						  <fieldset align="left"><legend class="fieldName">Rate &amp; Amount</legend>
<table>
 <tr height="30px"><td ><input name="rateNAmount" type="checkbox" id="rateNAmount" value="RA" <?=$rateNAmountCheck?> class="chkBox" onclick="removeChkLocal(document.frmDailyCatchSummary);enabrtAmount();"  <?php if (($p["RMMatrix"]=="RMM") || ( $p["RMRateMatrix"]=="RMRM") || ($p["qtySummary"]=="QSU")){?> disabled="true" <?php }?>></td>
                          ...
                          <tr>
							...
							<?
								...
								if (sizeof($tableHeader)>0)
									{
										$nextColumn	=	0;
										for($k=0;$k<sizeof($tableHeader);$k++){
											$tHeader	=	$tableHeader[$k];
											$nextColumn++;
											$checked = "";
											if($tHeader==$p["tHeader_".$k]) $checked = "checked";
											
									?>
							<td><input type="checkbox" name="tHeader_<?=$k?>" id="tHeader_<?=$k?>" value="<?=$tHeader?>" <?=$checked?> class="chkBox"></td>
							<td class="listing-item" nowrap style="padding-right:18px;"><?=$tHeader?></td>
							<? 
							...
							?>
							<input type="hidden" name="hidNumTableHead" id="hidNumTableHead" value="<?=$k?>">
							</tr>
							<tr>
							  <td align="center" height="5"></td>
							  </tr>
							<tr><td colspan="<?=$numColumn*2?>" align="center"><input name="cmdAdvSearch" type="submit" class="button" id="cmdAdvSearch" value="Search" onClick="return validateAdvanceSearch(document.frmDailyCatchSummary);"></td>
							</tr>
							</table>
							</fieldset></td>
                          </tr>
	...
	?>
                      ...
                      <tr> 
						...
						?>
							...
							<?
			/*
			 if(sizeof($dateWiseRecords)){
		  	foreach ($dateWiseRecords as $dwr)
			{		  
		  	$challanNo		=	$dwr[0];
			$Date3			=	explode("-",$dwr[1]);
			$selectDate		=	$Date3[2]."/".$Date3[1]."/".$Date3[0];	
			
			$supplierId		=	$dwr[2];
			$supplierRec	=	$supplierMasterObj->find($supplierId);
			$supplierName	=	$supplierRec[2];
			
			$centerRec			=	$landingcenterObj->find($dwr[3]);
			$landingCenterName		=	stripSlash($centerRec[1]);
			}}*/
			?>
                            <tr bgcolor="#FFFFFF"> 
	...
	?>
                  ...
                  <? echo number_format($totalWt,2);?>
                            ...
                            <tr bgcolor="#FFFFFF">
                              <td colspan="17" align="left" class="listing-head"><table width="70%" border="0" cellspacing="1" cellpadding="0" bgcolor="#999999">
							  <?
	...
	?>
		 ...
		 <? } ?>
                            ...
                            <!--tr bgcolor="white">
                              <td colspan="17"  height="5" align="center"><table width="55%" border="0" align="left" cellpadding="0" cellspacing="1" bgcolor="#999999">
							  	<? $columnSize = sizeof($RMChallanWiseRecords);?>
                                  <tr bgcolor="white"> 
                                    <td colspan="<?=$columnSize+2;?>" align="center" class="fieldName">RM  Summary Matrix </td>
                                  </tr>
								  
                                  <tr bgcolor="#f2f2f2">
                                    <td class="listing-head" style="padding-left:10px;">Date</td>
									<?
								  $j=0;
								  $gradeCode="";
								  $totalWt	=	"";
								...
								if($prevRecDate!=$sChallanDate){
									...
									//$RMChallanDate	=	$array[2]."/".$array[1]."/".$array[0];
									 $RMChallanDate		= 	date("d/m/y", mktime(0, 0, 0, $array[1], $array[2], $array[0]));
								} else {
									$RMChallanDate		= "&nbsp;";
								}
															
								?>
                                    <td rowspan="2" style="padding-left:2px; padding-right:2px;"><table width="50" border="0" align="center">
                                      <tr align="center">
                                        <td class="listing-head" style="line-height:normal; font-size:11px;"><?=$RMChallanDate?></td>
                                      </tr>
                                      <tr align="center">
                                        <td class="listing-head" style="line-height:normal; font-size:11px;"><?=$RMChallanNo?></td>
                                      </tr>
                                    </table></td>
								<?
								$prevRecDate	=	$sChallanDate;
								...
								?>
								<td rowspan="2" class="listing-head" style="padding-left:5px; padding-right:5px;">Total.Qty</td>
                                  </tr>
                                  <tr bgcolor="#f2f2f2">
                                    <td class="listing-head" style="padding-left:10px;">Wt. Challan No</td>
								  </tr>
                                  ...
                                  <? 
									...
									?>
                               <tr bgcolor="#FFFFFF"> 
                                  <td class="listing-item" nowrap style="padding-left:5px; padding-right:5px;"><table width="100" border="0" align="center">
                                        <tr>
                                          <td class="listing-head" align="center" style="line-height:normal; font-size:10px;"><?=$fishName?></td>
                                        </tr>
                                        <tr>
									...
									// echo "$RMEntryId,$entryFishId, $processCodeId, $count, G=$rmGradeId";
										
									?>
                                    <td class="listing-item" nowrap  align="right" style="padding-left:5px; padding-right:5px;"><?=$effectiveQty?></td>
									<? }?>
									<? 
									$grandTotalWt+=$totalEffectiveQty;
									?>
                                    <td class="listing-item" align="right" style="padding-left:5px; padding-right:5px;"><? echo number_format($totalEffectiveQty,2);?></td>
                                </tr>
                                  <? 
								  ...
								  ?>
								   <tr bgcolor="#FFFFFF">
                                    <td colspan="1" align="right" nowrap class="listing-head" style="padding-left:5px; padding-right:5px;">TOTAL  WT:</td>
                                    <?
									foreach($RMChallanWiseRecords as $rmcr)
									{
										$RMEntryId		= $rmcr[0];
										
										$totalColumnEffectiveWt = $dailycatchsummaryObj->findTotalEffectiveWt($RMEntryId,$selectUnit,$landingCenterId,$selectSupplier,$fishId,$processId);
										
									?>
                                    <td nowrap class="listing-item" align="right" style="padding-left:5px; padding-right:5px;"><strong><?=$totalColumnEffectiveWt?></strong></td>
									<? }?>
                                    <td class="listing-item" align="right" nowrap="nowrap" style="padding-left:5px; padding-right:5px;"><strong><? echo number_format($grandTotalWt,2);?></strong></td>
                                  </tr>								  
                                </table></td>
                      ...
                      <? if(sizeof($RMChallanWiseRecords)>0 && $RMMatrix!=""){?>
                            <tr bgcolor="white">
                              <td colspan="17"  height="5" align="center" style="padding-left:10PX;"><table width="55%" border="0" align="left" cellpadding="0" cellspacing="1" bgcolor="#999999">
					...
					if ($count=="" || $receivedBy=='B' || $receivedBy=='G') {
							...
							$gradeCode			=	stripSlash($gradeRec[1]);
                                    ...
                                    <td style="padding-left:2px; padding-right:2px">
                                      <table width="50" border="0" align="center">
                                        <!--tr>
                                          <td class="listing-head" align="center"><?=$fishName?></td>
                                        </tr-->
                                        <tr>
                                          <td class="listing-head" align="center" style="line-height:normal; font-size:10px;"><?=$processCode?></td>
                                        </tr>
...
<!-- Local Qty Report Start here-->
	...
	<!-- Daily Summary View Starts Here -->
		...
		<tr>
			...
			<tr bgcolor="White"><TD class="listing-head" colspan="13" align="center">Daily Summary View</TD></tr>
		<?
				...
				foreach ($getBillCompanyRecs as $gbcr) {
					...
					if ($prevLastRMChallanNumber!="" && $lastRMChallanNumber!="") {
						...
						<td class="home-listing-item">
							<? if($nextRec>1) echo ",";?><?=$alphaCode.$missingChallan?></td>
							<?php 
...
<!-- 	Decl Wt Supplier Setlement Starts Here -->
	...
	<td colspan="17" style="padding-left:10px;">
		...
		<tr align="center"><TD class="listing-head">COMMISSION</TD></tr>
...
<!--  RM Supplier Rate summary Matrix Ends Here-->
	...
	<!-- Qty Summary View Starts Here -->
		...
		<tr>
			...
			<tr bgcolor="White">
			<TD class="listing-head" colspan="10" align="center">Quantity Summary View</TD></tr>
		<?
	...
	<!-- Challan Summary View Starts Here -->
		...
		<tr>
			...
			<table cellpadding="1"  width="30%" cellspacing="1" border="0" bgcolor="#999999">
			<tr bgcolor="White">
			<TD class="listing-head" colspan="10" align="center">Challan Summary View</TD></tr>
		<?php
