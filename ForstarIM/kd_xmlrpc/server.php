...
$db = "forstar_server";      // Name of your MySQL database
$dbuser = "root";       // MySQL user with access to $db
$dbpassword = "ais2008";   // Password for MySQL user
...
/* Include Keiths xml-rpc library */
include("kd_xmlrpc.php");

/* Include a file that defines all the xml-rpc "methods" */
include("web_service_api.php");

/* Now use the XMLRPC_parse function to take POST data from what xml-rpc
   client connects and turn it into normal PHP variables */
$xmlrpc_request = XMLRPC_parse($GLOBALS['HTTP_RAW_POST_DATA']);

/* From the PHP variables generated, lets get the method name ie. server asks
   "What would you like me to do for you?" */
$methodName = XMLRPC_getMethodName($xmlrpc_request);

/* Get the parameters associated with that method e.g "So you want to view a
   news item. Tell me which one you want. What's the id#?" */
...
/* Otherwise, let's run the PHP function corresponding to that method
   - note the functions themselves return the correct formatted xml-rpc
