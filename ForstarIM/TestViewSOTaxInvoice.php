...
<html>
<head>
<title>VIEW SALES ORDER MEMO</title>
...
<table width="100%" cellpadding="2" cellspacing="0">
	...
	<th class="p-listing-head" style="padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" width="5%" nowrap="true">SR.<br/>NO</th>
        <th class="p-listing-head" style="padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" width="50%" nowrap="true">DESCRIPTION OF GOODS</th>
	<th class="p-listing-head" style="padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" width="6%" nowrap="true">M/C</th>
	<th class="p-listing-head" style="padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" width="6%" nowrap="true">IND<br/> PKTS</th>
	<th class="p-listing-head" style="padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" nowrap="true" width="7%">TOTAL<br/> PKTS</th>
	<th class="p-listing-head" style="padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" width="6%" nowrap="true">FREE<br/>PKTS</th>
        <th class="p-listing-head" style="padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" width="8%" nowrap="true">RATE PER <br/>UNIT (RS.)</th>
	<th class="p-listing-head" style="padding-left:3px; padding-right:3px; border-bottom: 1px solid #000000;" nowrap="true" width="12%">TOTAL<br/>(RS.)</th>
      </tr>
      <?php
	...
	?>
      <tr>
	<td height='20' class="listing-item" style="padding-left:3px; padding-right:3px; font-size:8pt;line-height:normal; padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" align="center"><?=$i?></td>
 	<td class="listing-item" style="padding-left:3px; padding-right:3px; font-size:8pt; padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" nowrap="true">
		<?=$productName?>
	</td>	
        <td class="listing-item" align="right" style="padding-left:3px; padding-right:3px; font-size:8pt; padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;"><?=$numMCPack?></td>
	<td class="listing-item" align="right" style="padding-left:3px; padding-right:3px; font-size:8pt;padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;"><?=$numLoosePack?></td>
	<td class="listing-item" align="right" style="padding-left:3px; padding-right:3px; font-size:8pt;padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;"><?=number_format($quantity,0,'.','');?></td>
        <td class="listing-item" style="padding-left:3px; padding-right:3px; font-size:8pt;padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" align="right"><?=$freePkts?></td>
        <td class="listing-item" style="padding-left:3px; padding-right:3px; font-size:8pt;padding-left:3px; padding-right:3px; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" nowrap="true" align="right" >
		<?php if ($invoiceType=='T') {?><?=number_format($unitRate,2,'.','');?><?} else {?>0 <?}?>
	</td>
	<td class="listing-item" style="padding-left:3px; padding-right:3px; font-size:8pt;padding-left:3px; padding-right:3px; border-bottom: 1px solid #000000;" align="right">
		<?=$total?>
	</td>
      </tr>
	  	<?php
...
<!-- Ends Here -->	
  ...
  <tr>
   ...
   ?>
	...
	<tr>		
		<td class="listing-item" align="right" style="padding-left:3px; padding-right:3px; font-size:8pt; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" colspan="6"><?=$discountRemark?></td>
        	<td class="listing-head" style="padding-left:3px; padding-right:3px; font-size:9px;line-height:normal; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" align="right" nowrap="true">(Less) <br/>DISCOUNT&nbsp;<?=$discountPercent;?>%</td>
                <td class="listing-item" align="right" style="padding-left:3px; padding-right:3px; font-size:8pt; border-right: 1px solid #000000; border-bottom: 1px solid #000000;"><strong><?=$discountAmt?></strong></td>
	</tr>
	<?php
		}
	?>
	...
	?>	
	<tr>
		<td height='25' colspan="6" nowrap="nowrap"  align="right" style="border-right: 1px solid #000000; border-bottom: 1px solid #000000;">
			<table cellspacing='0' cellpadding='0' width="100%">
				<tr>
