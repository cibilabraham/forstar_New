...
// 	echo "</pre>";
	...
	if ($challanMainId!="" || $challanMainId!=0) {
		...
		if ($challanMainId && $selSuppChallanNo) {
			$declaredWtRecords = $dailycatchreportObj->getSupplierDeclaredWtRecords($challanMainId, $selSuppChallanNo);
		}
	...
	if ($localQtyReportChk) {
		...
		$dailyCatchReportResultSetObj = $dailycatchreportObj->filterDailyCatchEntryRecords($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $weighNumber, $challanMainId);	
...
&nbsp;&nbsp;<? if($print==true){?>
	...
	<tr>
			...
			<table cellpadding="2" cellspacing="0">
				  ...
				  <input name="weighNumber" type="text" id="weighNumber" size="8" value="<?=$weighNumber?>"  onchange="xajax_getBillingCompanyRecs(document.getElementById('weighNumber').value, '<?=$selBillingCompany?>');" autocomplete="off"/>&nbsp;&nbsp;</td>
                            </tr>
			    <tr>
			  ...
			  <tr><TD colspan="2">
				<table>
				  ...
				  <td>&nbsp;</td>
				  <td valign="top" class="listing-item"><fieldset><legend class="listing-item">Supplier wise Search</legend><table cellpadding="2">
                            <tr>
...
#--------------------------------------------------------------------------
  ...
  <tr bgcolor=white>
    <td align="center" class="listing-head"><table width="100%" cellpadding="0" cellspacing="0" align="center">
      <tr>
        <td valign="top">
	<table width="100%" cellpadding="0" cellspacing="0">
		<? if(sizeof($countGrossRecords) && $dcr[41]=='B'){?>
	...
	<? }?>
		...
		<table width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td colspan="4" nowrap="nowrap"><table width="100%" cellpadding="0" cellspacing="0">
              <tr>
          ...
          <tr>
            <td colspan="4" class="fieldName" align="left"><table width="100%" cellpadding="0" cellspacing="0">
              <tr>
	...
	<tr><TD align="center"><table cellpadding="0" cellspacing="0"><TR><td class="fieldName" nowrap><strong>Effective Wt:</strong> </td>
            <td class="listing-item" nowrap>&nbsp;&nbsp;<strong><? echo number_format($effectiveWt,3);?></strong></td></TR></table></TD></tr>
...
?>
	...
	<? if ($moreSubSupplierExist) {?>
		<tr><td height="5" colspan="3" class="listing-item" style="color:#FF0000;" align="center"><strong>The selected Weighment Challan contains more than one sub-supplier</strong></TD></tr>
		<tr><TD height="5"></TD></tr>		
	<? }?>
	<tr>
