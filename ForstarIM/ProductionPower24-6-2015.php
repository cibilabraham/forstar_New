...
#List all Man Power
	...
	/*$manPowerResultSetObj = $productionPowerObj->fetchAllRecords($mpcRateList);*/
																							...
																							<tr>
																								<td nowrap >
																									...
																									<!--  MAN POWER -->
																										...
																										?>
																										<tr>
																											<td class="listing-item"><?=$fixedPrdName?></td>
																											<td class="listing-item"><input type="text" name="newfixedCost_<?=$i?>" id="newfixedCost_<?=$i?>"></td>
																											<td class="listing-item"><input type="text" readonly name="fixedCost_<?=$i?>" id="fixedCost_<?=$i?>" value="<?=number_format((float)$totalFixed, 2, '.', '');?>"></td>
																										</tr>
																										<? $i++;
																										} ?>
																										...
																										?>
																										<tr>
																											<td class="listing-item"><?=$varPrdnName?></td>
																											<td class="listing-item"><input type="text" name="newfixedCost_<?=$j?>" id="newfixedCost_<?=$j?>"></td>
																											<td class="listing-item"><input type="text" readonly name="fixedCost_<?=$j?>" id="fixedCost_<?=$j?>" value="<?=number_format((float)$totalVar, 2, '.', '');?>"></td>
																										</tr>
																										<? $j++;
																										} ?>
