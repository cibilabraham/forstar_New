<?php
	...
	$selFilterStkType = $g["selFilterStkType"];

	#List All Records
	$physicalStockRecords = $physicalStockEntryObj->fetchAllRecords($selFilterStkType);
...
<table cellpadding="2"  width="60%" cellspacing="1" border="0" align="center" bgcolor="#999999">
	...
	<tr  bgcolor="#f2f2f2" align="center">
		...
		<td class="listing-head" style="padding-left:10px; padding-right:10px;">Stock Type</td>		
	</tr>
	<?
