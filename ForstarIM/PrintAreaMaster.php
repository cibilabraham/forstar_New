<?php
	...
	$selCityFilter = $g["selCityFilter"];
	#List All Records
	$areaResultSetObj = $areaMasterObj->fetchAllRecords($selCityFilter);
...
<table cellpadding="2"  width="70%" cellspacing="1" border="0" align="center" bgcolor="#999999">
		...
		<tr  bgcolor="#f2f2f2" align="center">
			...
			?>
			<tr  bgcolor="WHITE">				
				<!--<td class="listing-item" nowrap="nowrap" style="padding-left:10px; padding-right:10px;"><?=$areaCode;?></td>-->
