								...
								<tr>
									...
									<td colspan="2" >
										<table cellpadding="1"  width="75%" cellspacing="1" border="0" align="center" bgcolor="#999999">
											...
											?>
											<tr  bgcolor="WHITE"  >
												<td height="25" nowrap class="listing-item" style="padding-left:10px;"><?=$freezingName;?></td>
												<td class="listing-item" nowrap="nowrap" style="padding-left:10px;"><?=$freezingDescr;?></td>
												<? if($edit!=true){?>
											  <? }?>
											</tr>
											<?
