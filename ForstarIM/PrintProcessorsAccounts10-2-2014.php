<?
	...
	$offset		=	$g["offset"];
	$limit		=	$g["limit"];	
	$dailyPreProcessRecords	=	$processorsaccountsObj -> fetchAllRecords($fromDate, $tillDate, $processor, $offset, $limit);
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#f2f2f2">
				...
				?>
                                  ...
                                  <tr bgcolor="white">
                                    <td height="10" colspan="8" align="right" class="listing-head">Total:</td>
                                  ...
                                  <!--tr bgcolor="white">
                                    <td height="10" colspan="8" align="right" class="listing-head">Grand Total: </td>
                                    <td height="10" align="center" style="padding-left:2px; padding-right:2px;" class="listing-item"><b><?=$grandTotalProcessRate?><b></td>
				...
				<? }?>
                                  ...
                                  <tr bgcolor="#FFFFFF">
                                    <td colspan="12" height=1><table width="450">
                                        <tr>
