<?
	...
	if ($p["cmdAdd"]!="") {
		...
		if ($purchaseOrderNo!="")
		{
			$purchaseOrderRecIns	=	$purchaseOrderInventoryObj->addPurchaseOrder($purchaseOrderNo, $poNumber, $selSupplierId, $userId, $hidSupplierRateListId,$compnyId,$remarks,$totalQuantity,$delivarydate,$deliveredto,$vat,$transport,$excise,$factory,$bearer,$unitpo);
													...
													<table cellpadding="1"  width="80%" cellspacing="2" border="0" align="center" bgcolor="#e8edff" style="border:1px #999999 solid; border-radius: 5px;">
														<tr>
															...
															<td class="listing-item">
																<select id="company" name="company"  onchange="xajax_getUnit(document.getElementById('company').value,'','');"<?php if ($editMode){ ?> disabled="true" <?php }?>>
															...
															<td class="listing-item">
																<select onchange="xajax_getPONumber('<?=$selDate?>',document.getElementById('company').value,document.getElementById('unitpo').value); xajax_getMinimumRequisitionQty('0',document.getElementById('selStock_0').value,document.getElementById('company').value,document.getElementById('unitpo').value,document.getElementById('quantity_0').value,document.getElementById('selSupplier').value);" id="unitpo" name="unitpo" <?php if ($editMode){ ?> disabled="true" <?php }?>>
																	<option value=''>--Select--</option>
																	<?php
