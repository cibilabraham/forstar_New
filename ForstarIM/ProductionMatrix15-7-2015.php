<?php
	...
	#Add 
	if ($p["cmdAdd"]!="") {
		$prodCode	= addSlash(trim($p["prodCode"]));
	...
	if ($p["cmdSaveChange"]!="") {
		...
		if ($productionMatrixRecId!="" && $prodCode!="" && $prodName!="") {
			$productionMatrixRecUptd = $productionMatrixObj->updateProductionMatrix($productionMatrixRecId, $prodCode, $prodName, $fillingWtPerPouch, $prodQtyPerBtch, $noOfPouch, $processedWtPerBtch, $noOfHrsPrep, $noOfHrsCook, $noOfHrsFill, $noOfHrsRetort, $noOfHrsFirstBtch, $noOfHrsOtherBtch, $noOfBtchsPerDay, $boilerRequired, $dieselCostPerBtch, $electricityCostPerBtch, $waterCostPerBtch, $gasCostPerBtch, $totFuelCostPerBtch, $maintCostPerBtch, $variManPwerCostPerBtch, $mktgTeamCostPerPouch, $mktgTravelCost, $adCostPerPouch, $userId);
		}
	...
	if ($p["editId"]!="") {
		...
		$prodCode		= $productionMatrixRec[1];
		$prodName		= $productionMatrixRec[2];
		$fillingWtPerPouch 	= $productionMatrixRec[3];
		$prodQtyPerBtch		= $productionMatrixRec[4];
		$noOfPouch		= $productionMatrixRec[5];
		$processedWtPerBtch 	= $productionMatrixRec[6];
		$noOfHrsPrep		= $productionMatrixRec[7];
		$noOfHrsCook		= $productionMatrixRec[8];
		$noOfHrsFill		= $productionMatrixRec[9];
		$noOfHrsRetort		= $productionMatrixRec[10];
		$noOfHrsFirstBtch	= $productionMatrixRec[11];
		$noOfHrsOtherBtch	= $productionMatrixRec[12];
		$noOfBtchsPerDay	= $productionMatrixRec[13];
		$boilerRequired		= $productionMatrixRec[14];
		$dieselCostPerBtch	= $productionMatrixRec[15];
		$electricityCostPerBtch = $productionMatrixRec[16];
		$waterCostPerBtch	= $productionMatrixRec[17];
		$gasCostPerBtch		= $productionMatrixRec[18];
		$totFuelCostPerBtch	= $productionMatrixRec[19];
		$maintCostPerBtch	= $productionMatrixRec[20];
		$variManPwerCostPerBtch = $productionMatrixRec[21];
		$mktgTeamCostPerPouch	= $productionMatrixRec[22];
		$mktgTravelCost		= $productionMatrixRec[23];
		$adCostPerPouch		= $productionMatrixRec[24];
	}
...
<!-- 	Ist Column -->
					...
					<table>
					 <tr>
					  ...
					  <td>
					  <input type="text" name="prodCode" size="20" value="<?=$prodCode?>" /></td>
				  	</tr>	
					<tr>
					  <td class="fieldName" nowrap >*Product Name</td>
					  <td>
					  <input type="text" name="prodName" size="20" value="<?=$prodName?>" /></td>
				  	</tr>	
					<tr>
					...
					<tr>
					  ...
					  <td class="listing-item"><input type="text" name="noOfPouch" size="5" id="noOfPouch" value="<?=$noOfPouch?>" style="text-align:right;" onkeyup="calcProcessedWtPerBatch(); calcNumHrsForFillNSeal();"></td>
					</tr>
					<tr>
					...
					<tr>
					  ...
					  <td class="listing-item"><input type="text" name="noOfHrsPrep" size="5" id="noOfHrsPrep" value="<?=$noOfHrsPrep?>" style="text-align:right;" onkeyup="calcNumHrsForFirstBtch(); calcNumHrsForOtherBtch(); calcNumBtchPerDay();"></td>
					</tr>
					<tr>
					  <td class="fieldName" nowrap >*No of Hours for Cooking</td>
					  <td class="listing-item"><input type="text" name="noOfHrsCook" size="5" id="noOfHrsCook" value="<?=$noOfHrsCook?>" style="text-align:right;" onkeyup="calcNumHrsForFirstBtch(); calcNumHrsForOtherBtch(); calcNumBtchPerDay();"></td>
					</tr>
					</table>
					</TD>
<!-- IInd Column -->
					<td valign="top">
						<table>							
							<tr>
					  		...
					  		<td class="listing-item"><input type="text" name="noOfHrsFill" size="5" id="noOfHrsFill" value="<?=$noOfHrsFill?>" style="text-align:right;" readonly onchange="calcNumHrsForFirstBtch(); calcNumHrsForOtherBtch(); calcNumBtchPerDay();"></td>
							</tr>
							<tr>
					  		<td class="fieldName" nowrap >*No of Hours for Retorting</td>
					  		<td class="listing-item"><input type="text" name="noOfHrsRetort" size="5" id="noOfHrsRetort" value="<?=$noOfHrsRetort?>" style="text-align:right;" onkeyup="calcNumHrsForFirstBtch(); calcNumHrsForOtherBtch(); calcNumBtchPerDay();"></td>
							</tr>
							<tr>
					  		<td class="fieldName" nowrap >*No of Hours for First Batch</td>
					 		 <td class="listing-item"><input type="text" name="noOfHrsFirstBtch" size="5" id="noOfHrsFirstBtch" value="<?=$noOfHrsFirstBtch?>" style="text-align:right;" readonly onchange="calcNumHrsForOtherBtch(); calcNumBtchPerDay();"></td>
							</tr>
							<tr>
							<td class="fieldName" nowrap >*No of Hours for other Batches</td>
					 		 <td class="listing-item"><input type="text" name="noOfHrsOtherBtch" size="5" id="noOfHrsOtherBtch" value="<?=$noOfHrsOtherBtch?>" style="text-align:right;" readonly onchange="calcNumBtchPerDay();"></td>
							</tr>
							<tr>
							...
							<tr>
					  		<td class="fieldName" nowrap >*Boiler Required</td>
