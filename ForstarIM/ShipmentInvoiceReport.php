<?php
	...
	require_once("lib/ShipmentInvoiceReport_ajax.php");
	...
	if ($p["cmdSearch"]!="" || $g["cmdSearch"]!="") {
		if ($fromDate!="" && $fromDate!="") {
			$debitNoteRecs = $shipmentInvoiceReportObj->debitNoteRecs($fromDate, $tillDate, $selShippingLineId);		
			$searchMode = true;
		}
	}

	if ($searchMode) {
		$shippingLineRecs = $shipmentInvoiceReportObj->getShippingLineRecs($fromDate, $tillDate);
	}
	...
	$ON_LOAD_PRINT_JS = "libjs/ShipmentInvoiceReport.js";	

	# Include Template [topLeftNav.php]
	require("template/topLeftNav.php");
?>
	<form name="frmShipmentInvoiceReport" action="ShipmentInvoiceReport.php" method="post">
						...
						<td   bgcolor="white">
							...
							<table cellpadding="0"  width="100%" cellspacing="0" border="0" align="center">
								<tr>
									...
									<td background="images/heading_bg.gif" class="pageName" >&nbsp;Shipment Invoice Report</td>
					...
					<table><TR><TD>
						...
						<table>
							...
							?>
								...
								<TD>&nbsp;</TD>
								<td class="listing-item">
									<INPUT TYPE="submit" class="button" name="cmdSearch" value="Generate Report" onclick="return validateShipmentInvoiceReport();">
								</td>
							</TR>						
						</table>
					</fieldset>
	...
	<tr>
		...
		<? if ($print==true) {?>
		<input type="button" name="cmdAdd" class="button" value=" Print " onClick="return printWindow('PrintShipmentInvoiceReport.php?dateFrom=<?=$dateFrom?>&dateTill=<?=$dateTill?>&selShippingLine=<?=$selShippingLineId?>',700,600);">
		<? }?>
		</td>
		</tr>
	<tr>
