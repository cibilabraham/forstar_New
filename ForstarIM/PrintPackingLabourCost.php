<?php
	...
	#List All Records
	$packingLabourCostResultSetObj = $packingLabourCostObj->fetchAllRecords($selRateList);
...
<table cellpadding="2"  width="80%" cellspacing="1" border="0" align="center" bgcolor="#999999">
		...
		?>
			...
			<?
			while(($fcr=$packingLabourCostResultSetObj->getRow())) {
				$i++;
				$packingLabourCostRecId 	= $fcr[0];
