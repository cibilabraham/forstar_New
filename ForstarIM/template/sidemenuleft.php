...
<table cellpadding="0" cellspacing="0" align="left" width="200" border="1" style= "border: 1px solid #ddd;background-color:#f5f5f5;">
	...
	<td class="rounded-company" widh="20%" style="cursor:hand;padding-left:5px;">
		<?php 
			...
			if($pn=='productspex' or $pn=='productidentifiermaster' or $pn=='productstatus' or $pn=='distmarginstructure' or $pn=='productbatch'){
				$vardisplay="block;" ;
				$isstrong = true;
			} 
			
			if($isstrong) echo "<a href='ProductSpex.php' onclick='javascript:funcSubmenu(1); style='text-decoration:none;'><strong> >> Product </strong></a>";  	
			else echo "<a href='ProductSpex.php' style='text-decoration:none;'> >> Product </a>";  
		?>	
		<br>
	<div id="1" style="display:<?=$vardisplay?>;padding-left:5px;">
	<table cellpadding="0" cellspacing="0" border="0" >
		<tr>
			<td><a href='DistMarginStructure.php' style='text-decoration:none;'> 
			<?php
				if($pn=='distmarginstructure')
					echo "<strong> >> Distributor Margin Structure</strong>"; 
				else echo ">> Distributor Margin Structure";
			?>
				</a>
			</td>
		</tr>
