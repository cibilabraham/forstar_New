...
<?php
	...
	$ROOT_PATH	= "http://" . $host . $INSTALLATION_PATH;
	$file = fopen($ROOT_PATH.'/libjs/JSFiles.php', "r");
    	while (!feof($file)) {
        	$latestVal = fread($file,1024);
	}
	*/
	$latestVal = "";
	$host  = $_SERVER['HTTP_HOST'];	
...
<!--<script type="text/javascript" src="<?//$ROOT_PATH?>/libjs/JSFiles.php?version=<?php //require($ROOT_PATH.'/libjs/JSFiles.php');?>"></script>-->
<SCRIPT LANGUAGE="JavaScript">
	<!--
	<?php		
