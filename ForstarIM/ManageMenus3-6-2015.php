								...
								<tr>
									...
									<td  height="10" align="right" style="padding-bottom:5px">
										<table  cellpadding="0" width="50%" cellspacing="2" border="0" style="background-color:#cccccc">
											<tr>
												<td align="center" nowrap bgcolor="#e8edff"><a onclick="getModule();" href="javascript:void(0)">add/edit Module</a></td>
												<td align="center" nowrap bgcolor="#e8edff"><a onclick="getSubModule();" href="javascript:void(0)">add/edit Sub Module</a></td>
												<td align="center" nowrap bgcolor="#e8edff"><a onclick="getMenu();" href="javascript:void(0)">add/edit Function</a></td>
											</tr>
										</table>
									</td>
								</tr>
															...
															<td colspan="3" align="center">
																...
																<? if($maxpage>1){?>
																	...
																	<tr  bgcolor="#f2f2f2" >
																		...
																		<td class="listing-head" align="center" style="padding-left:10px; padding-right:10px;">Main Menu</td>
																		<td class="listing-head" align="center" style="padding-left:10px; padding-right:10px;">Sub Menu</td>
																		<td class="listing-head" align="center" style="padding-left:10px; padding-right:10px; width:247px " >Menu</td>
																		<? 
																		/*
																		if($edit==true){?>
																	...
																	<?
																	foreach ($moduleRecords as $sir) {
																	
																		$i++;
																		$moduleId	=	$sir[0];
																		$moduleName	=	$sir[1];
																		//$subModuleRecords=$manageMenuObj->getSubMenus($moduleId);
																		list($submenu,$menu)=$manageMenuObj->getListing($moduleId);
																	?>
																	<tr  bgcolor="WHITE">
																		<!--<td width="20">
																			<input type="checkbox" name="delId_<?=$i;?>" id="delId_<?=$i;?>" value="<?=$procurementId;?>" class="chkBox">
																		</td>-->
																		<td class="listing-item" nowrap style="padding-left:10px; padding-right:10px;" valign="top" bgcolor="#E4DDF8"><?=$moduleName;?></td>
																		<td class="listing-item" nowrap  colspan="2" bgcolor="#E6E0F8">
																		<table cellpadding="3" cellspacing="1" bgcolor="#999999">
																			<?
																			//printr();
																			if($submenu>0)
																			{
																			foreach($submenu as $sm=>$value)
																			{
																				
																			?>
																			<tr bgcolor="#FDE9E2"  ><td style="width:203px" class="listing-item"  valign="top" nowrap><?=$value?></td>
																				<td >
																					<table cellpadding="3" cellspacing="1" bgcolor="#999999">
																						<?
																						$menus=$menu[$sm];
																						...
																						{
																						?>
																						<tr bgcolor="#EFFBFB"><td class="listing-item" style="width:247px" nowrap  valign="top"><?=$mn?></td></tr>	
																						<?
																						}
																						?>
																					</table>
																			...
																			{
																			?>
																			<tr bgcolor="WHITE"  ><td style="width:203px" class="listing-item"  valign="top" nowrap>&nbsp;</td>
																				<td>
																					<table cellpadding="3" cellspacing="1" bgcolor="#999999">
																						<?
																						$menus=$menu[0];
																						...
																						{
																						?>
																						<tr bgcolor="WHITE"><td class="listing-item" style="width:250px" nowrap  valign="top"><?=$mn?></td></tr>	
																						<?
																						}
																						?>
																					</table>
