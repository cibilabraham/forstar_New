...
# Variable resetting section	
	...
	if ($p["editId"]!="" ) {
		...
		$frozen		= ($stockRec[43]=='Y')?"checked":"";	
		$rte		= ($stockRec[44]=='Y')?"checked":"";	
		#Get Sub Category
						...
						?>
																			...
																			<table cellpadding="0"  width="65%" cellspacing="0" border="0" align="center">
																				...
																				<tr>
																					...
																					<td colspan="2" align="center">
																						...
																						<input type="submit" name="cmdSaveChange" class="button" value=" Save Changes " onclick="return validateStock(document.frmStockEntry);" />
																					</td>
																					<?} else{?>
																					<td  colspan="2" align="center">
																						<input type="submit" name="cmdCancel" class="button" value=" Cancel " onClick="return cancel('StockEntry.php');">&nbsp;&nbsp;
																												...
																												<table>
																													...
																													<tr>
																														...
																														<td nowrap>
																															...
																															<textarea name="description" style="width:165px;"><?=$stockDescr;?></textarea>
																														</td>
																													</tr>
																													<tr>
																														...
																														<td>
																															<table>
																																...
																																<tr>
																																	...
																																	<td>&nbsp;<a href="###" id='addRow' onclick="javascript:addNewItem2();"  class="link1" title="Click here to add new item."><img  SRC='images/addIcon.gif' BORDER='0' style='border:none;padding-right:0px;vertical-align:middle;' >Add Item</a>
																																	</td>
																																</tr>
																																<tr>
																																		...
																																		<td>
																																			<table cellpadding="0" cellspacing="0">
																																				<TR>
																																					...
																																					<td class="listing-item"><div id="minOrderQtyPerUnitTxt"></div>
																																					</td>
																																				</TR>
																																			</table>
																																		</td>
																															...
																															<TD valign="top">
																																...
																																?>
																																	<table border=0>
																																		...
																																		<tr>
																																			<td><a href="###" id='addRow' onclick="javascript:addNewItem1();"  class="link1" title="Click here to add new item."><img  SRC='images/addIcon.gif' BORDER='0' style='border:none;padding-right:0px;vertical-align:middle;' >Add Item</a>
																																			</td>
																																		</tr>
																																		<tr>
																																					...
																																					<TR>
																																						...
																																						<TD>
																																							<table>
																																								...
																																								<TR>
																																									<TD><input type="button" value="Add" onclick="addAttribute(document.getElementById('selFullFrozenCode'), document.getElementById('selFrozenCode'), 'R');" title="Add one by one" style="width:70px;"/></TD></TR>
																																								<TR>
																																									<TD></TD></TR>
													...
													<TR>
														...
														?>
															<table cellpadding="4" cellspacing="4">
																...
																<tr>
																	<td class="listing-item" style="padding-left:5px; padding-right:5px;">Stock
																	</td>
																	<td> 		
																		<input type="text" name="stockitemsearch" id="stockitemsearch" value="" />
																	</td>
																	<td  colspan="3">
							...
							<tr>
								...
								<tr title="<?=$displayTitle?>" <?php if ($active==0){?> bgcolor="#afddf8"  onMouseOver="ShowTip('<?=$disMsgInactive?>');" onMouseOut="UnTip();" <?php }?>>
									...
									if($existingcount==0){
									?>
									<input type="checkbox" name="delId_<?=$i;?>" id="delId_<?=$i;?>" value="<?=$stockId;?>" class="chkBox"></td>
									<?php 
									}
									?>
											...
											<tr  bgcolor="#f2f2f2">
												<td colspan="2" bgcolor="#e8edff" align="center">
													...
													?>
														...
														{
														?>
														<td colspan="2" class="listing-item" align="center">&nbsp; No records</td>
														<?
														}
														?>
													<!--</td>-->
