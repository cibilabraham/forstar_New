...
$selection = "?pageNo=".$p["pageNo"]."&selectFrom=".$p["selectFrom"]."&selectTill=".$p["selectTill"];
					...
					if($supplier_id!="")
					{
						...
						if($sizevalSupplier>1)
						{
							for($j=0;$j<$sizevalSupplier;$j++)	
							{
								...
								$rmlotIdListVal = $objManageRMLOTID->addManageLotIdDetail($lastId,$receipe,$receiptGate,$supply,$farm,$supplierChellanDts,$supplierchellan);
							}
						}
						else
						{
							...
							{
								$rmlotIdListVal = $objManageRMLOTID->addManageLotIdDetail($lastId,$receipt_idval,$receiptGatePass,$supplier_id,$farmIdVal,$supplierChellanDate,$supplierChellanVal);
							} 
						}
					}
	...
	for ($i=0; $i<$rowCounts; $i++)
		{		//echo "hii";
				...
				$upSupplier= $objManageRMLOTID->updateDetailofRmlotId($rm_lot_id,$rmlotID_Detail,$editRmlotID,$receipt,$receiptGatePassId,$supplier_id,$pond_id);
											...
											<tr>
												...
												*/?>
												...
												<input type="hidden" name="procurement_id" id="procurement_id" value="<?php echo $prid;?>"/>
																				...
																				<?php
																					...
																					$n=0;
																						...
																						<td class="listing-head" nowrap><?php echo $supplierName;?>
																									<input type="hidden" value="<?php echo $s?>upplierVal[1];?>" size="15" id="supplier_id_<?php echo $n;?>" name="supplier_id_<?php echo $n;?>" required />
																									</td>
																									<td class="listing-head" nowrap><?php echo $pondName;?>
																									<input type="hidden" value="<?php echo $supplierVal[2];?>" size="15" id="pond_id_<?php echo $n;?>" name="pond_id_<?php echo $n;?>" required /></td>
																									<td class="listing-head" nowrap>
																									...
																									<input type="hidden" size="15" name="challan_date_<?php echo $n;?>" id="challan_date_<?php echo $n;?>" value="<?php echo$challan_date;?>" required /></td>
																									
																									<td class="listing-head" nowrap>
																									<select id="Company_Name_<?php echo $n;?>" name="Company_Name_<?php echo $n;?>" required/>
														...
														<tr><td colspan="4" align="center"><table align="center" >
																		<?php for($i=0; $i<=$cnt; $i++)
																		{
																		?>
																		<tr><td  id='display_lotId_<?php echo $i;?>'  class="listing-head">
																		</td>
																		<td colspan="2">
																		...
																		<tr><td  ><input type="submit" value="Generate " name="cmdGenerate" class="button" onClick="return GenerateRmLotId(this.form,'rm_lot_',<?=$cnt;?>); "></td>
																			...
																			<tr bgcolor="#f2f2f2" align="center">
																				...
																				<?php
																					...
																					$n=0;
																						...
																						<td class="listing-item" nowrap><?=$supplierVal[2].$supplierVal[3];?>
																						<input type="hidden" id="editRmlotID_<?php echo $n;?>" name="editRmlotID_<?php echo $n;?>" value="<?php echo $editId;?>"  />
																						<input type="hidden" id="editRmlotIDName_<?php echo $n;?>" name="editRmlotIDName_<?php echo $n;?>" value="<?=$supplierVal[2].$supplierVal[3];?>"  />
																...
																<td colspan="2" id="lotIdList">
																	<table width="92%" border="0" bgcolor="#999999" align="center" cellspacing="1" cellpadding="2">
																		...
																		<!--<thead>
																			...
																			<!--	<td align="center" style="padding-left:10px; padding-right:10px;" class="listing-head">ID Type</td>-->
																				...
																				<!--<td style="padding-left:10px; padding-right:10px;" class="listing-head">Previous Processing Stage</td>-->
																				...
																				<table cellpadding="0" cellspacing="0" >
																					...
																					<select id="CompanyName" name="CompanyName" />
																								...
																								if(sizeof($companyNames) > 0)
																								{
																									...
																									{
																										$sel = '';
																										if($companyNm == $companyName['id']) $sel = 'selected';
																					...
																					<td>
																					<?php if ($processStage!="" && $processStage=="RM") $selectRM="selected";
																			   ...
																			   <select id="unitName" name="unitName" >
																										...
																										<?php
																											...
																											if(sizeof($units) > 0)
																											{
																												...
																												{
																													$sel = '';
																													if($unitNm == $unitval['id']) $sel = 'selected';
															...
															<tr>	
																<!--<td colspan="3">
																	<table align="center" cellspacing="0" cellpadding="0">
																		<tbody>
																		<tr>
																			<td nowrap=""><input type="submit" onclick="return confirmDelete(this.form,'delId_',4);" name="cmdDelete" class="button" value=" Delete ">&nbsp;<input type="submit" class="button" name="cmdAddNew" value=" Add New ">&nbsp;<input type="button" onclick="javascript:printWindow('PrintUnitTransfer.php',700,600);" class="button" name="btnPrint" value=" Print "></td>
																		</tr>
																		</tbody>
																	</table>									
																</td>-->
									...
									<td colspan="2" style="padding-left:10px; padding-right:10px;"   >
										...
										<? if($maxpage>1){?>
											...
											<tr align="center" bgcolor="#f2f2f2">
												...
												<th class="listing-head" style="padding-left:10px; padding-right:10px;">RMlotID</th>
