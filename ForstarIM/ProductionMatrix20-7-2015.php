<?php
	...
	if ($p["cmdSaveChange"]!="") {
		...
		if ($productionMatrixRecId!="" && $prodName!="") {
			$productionMatrixRecUptd = $productionMatrixObj->updateProductionMatrix($productionMatrixRecId, $prodName,$processType,$fillingWtPerPouch, $prodQtyPerBtch, $noOfPouch, $processedWtPerBtch, $noOfHrsPrep, $noOfHrsCook,$noOfHrsFilling	,$noOfHrsFill, $noOfHrsRetort, $noOfHrsFirstBtch, $noOfHrsOtherBtch,$gasRequired,$boilerRequired, $electRequired,$boilerRequiredProcessing,$noOfBtchsPerDay,$dieselCostPerBtch, $electricityCostPerBtch, $waterCostPerBtch, $gasCostPerBtch, $totFuelCostPerBtch, $maintCostPerBtch, $variManPwerCostPerBtch, $mktgTeamCostPerPouch,$coordinationCostPerPouch,$mktgTravelCost, $adCostPerPouch,$facilityCostPerDay);
		}
	...
	if ($p["editId"]!="") {
		...
		$noOfHrsFilling		= $productionMatrixRec[9];
		$noOfHrsFill		= $productionMatrixRec[10];
		$noOfHrsRetort		= $productionMatrixRec[11];
		$noOfHrsFirstBtch	= $productionMatrixRec[12];
		$noOfHrsOtherBtch	= $productionMatrixRec[13];
		$noOfBtchsPerDay	= $productionMatrixRec[14];
		$gasRequired		= $productionMatrixRec[15];
		$boilerRequired		= $productionMatrixRec[16];
		$electRequired		= $productionMatrixRec[17];
		$boilerRequiredProcessing		= $productionMatrixRec[18];
		$dieselCostPerBtch	= $productionMatrixRec[19];
		$electricityCostPerBtch = $productionMatrixRec[20];
		$waterCostPerBtch	= $productionMatrixRec[21];
		$gasCostPerBtch		= $productionMatrixRec[22];
		$totFuelCostPerBtch	= $productionMatrixRec[23];
		$maintCostPerBtch	= $productionMatrixRec[24];
		$variManPwerCostPerBtch = $productionMatrixRec[25];
		$coordinationCostPerPouch = $productionMatrixRec[26];
		$mktgTeamCostPerPouch	= $productionMatrixRec[27];
		$mktgTravelCost		= $productionMatrixRec[28];
		$adCostPerPouch		= $productionMatrixRec[29];
		$facilityCostPerDay = $productionMatrixRec[30];
	}
																								...
																								<TD valign="top">
																									<table>
																										...
																										<tr>
																											...
																											<td><input type="text" name="hrsForCooking" size="5" id="hrsForCooking" value="<?=$hrsForCooking?>" style="text-align:right;" ></td>
																										</tr>
