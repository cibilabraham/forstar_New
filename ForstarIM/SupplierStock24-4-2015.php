<?php
	...
	if ($p["editId"]!="") {
		...
		//$layer			=	sizeof($layerRecs);
		//echo "The value of layer is $layer";
		sizeof(($companyUnitRecs)>1)?$stckDisabled="disabled":$stckDisabled="";
	}
	...
	if ($p["cmdDelete"]!="") {
		...
		for ($i=1; $i<=$rowCount; $i++) {
			...
			if ($supplierStockId!="") {
				...
				$supplierStockCmpUnitDel =	$supplierstockObj->deleteSupplierCompanyUnit($supplierStockId);	
			}
		}
...
<form name="frmSupplierStock" action="SupplierStock.php" method="post">
																							...
																							<td colspan="2" valign="top">
																								<table>
																									...
																									<tr>
																										...
																										<td nowrap="true">			
																											<select name="selStock" id="selStock" <?=$stckDisabled?> onchange="<? if ($addMode==true) { ?>this.form.submit();<? } else { ?> this.form.editId.value=<?=$editId?>;this.form.submit();<? }?>" style="width:150px;">			
																												<option value="">--select--</option>
																												<?php
																										...
																										<td>
																											<table>
																												<tr>
																													...
																													<td nowrap  nowrap class="fieldName">*Unit</td>
																												</tr>
																												<? 
																									...
																									<tr>
																										<td></td>
																										<td>
																											<table id="tblPOItem2"></table>
																										</td>
																									</tr>
																									<tr>
																										<td>&nbsp;<input type='hidden' name="hidTableRowCount2" id="hidTableRowCount2" value="<?=$i;?>"></td>
	...
	?>
		<script>
			fieldIdStock='<? echo sizeof($companyUnitRecs)?>';
