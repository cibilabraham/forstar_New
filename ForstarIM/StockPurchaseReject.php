<?php
	...
	if ($p["cmdSearch"]!="") {
		...
		//$stockSize	=	sizeof($stockPurchaseRejectRecords);
	}
	...
	$ON_LOAD_PRINT_JS	= "libjs/StockPurchaseReject.js";

	# Include Template [topLeftNav.php]
	require("template/topLeftNav.php");
?>

	<form name="frmStockPurchaseReject" action="StockPurchaseReject.php" method="post">
						...
						<td   bgcolor="white">
							...
							<table cellpadding="0"  width="100%" cellspacing="0" border="0" align="center">
								<tr>
									...
									<td background="images/heading_bg.gif" class="pageName" >&nbsp;Stock Purchases & Rejection</td>
								  ...
								  <td colspan="2" ><table cellpadding="0"  width="65%" cellspacing="0" border="0" align="center">
                                    ...
                                    <tr>
                                      ...
                                      <td colspan="3" align="center">&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="button" name="cmdPrint" class="button" value=" Print " onClick="return printWindow('PrintStockPurchaseReject.php?stockFrom=<?=$dateFrom?> &stockTo=<?=$dateTill?>&selSupplier=<?=$selSupplierId?>',700,600);" <? if (!$stockPurchaseRejectRecords) echo "disabled";?>>&nbsp;&nbsp; </td>
                                      <?}?>
				<tr>
					...
					<td nowrap>&nbsp;<input type="submit" name="cmdSearch" value=" Search " class="button" onClick="return validateStkPurchaseRejectSearch(document.frmStockPurchaseReject)"></td>
                                  </tr>
