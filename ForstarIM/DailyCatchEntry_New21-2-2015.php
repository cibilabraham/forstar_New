									...
									<tr> 
										...
										<!-- Entry section starts here -->
											<table cellpadding="0"  width="60%" cellspacing="0" border="0" align="left">
												...
												<tr><TD colspan="4" id="challanErrMsg" class="err1" align="center"></TD></tr>
												<tr>
																						...
																						<table align="center" cellpadding="0" cellspacing="0">
																							<tr>
																								...
																								<td align="left" nowrap>
																									...
																									?>
																									<select name="unit" id="unit" tabindex="1" onkeypress="return focusNextBox(event,'document.frmDailyCatch','landingCenter');">
																										<option value="">--Select--</option>
																										<?php 
																							...
																							<tr>
																								...
																								?>
																								<input name="supplyChallanNo" type="text" id="supplyChallanNo" size="6" value="<?=$recordChallanNo?>" tabindex="6" onkeypress="return focusNextBox(event,'document.frmDailyCatch','weighChallanNo');" autocomplete="off" <?=$disableField?>/></td>
																							</tr>
																							<tr>
																								...
																								<td nowrap>
																									...
																									?>
																									<select name="billingCompany" id="billingCompany" onchange="xajax_getBillingCompanyRec(document.getElementById('billingCompany').value); xajax_chkValidCNum(document.getElementById('billingCompany').value, document.getElementById('weighChallanNo').value, document.getElementById('selectDate').value, document.getElementById('entryId').value, '<?=$mode?>'); xajax_chkValidDate(document.getElementById('selectDate').value, document.getElementById('billingCompany').value, '<?=$mode?>');">
																									<option value="">--Select--</option>
																									<?php
																	...
																	<table align="center" width="96%" cellpadding="0" cellspacing="0">
																		<tr>
																			...
																			<td nowrap="true">
																				...
																				?>
																				<input name="alphaCode" type="text" id="alphaCode" size="2" value="<?=$alphaCode?>" autocomplete="off" style="text-align:center; width:15px; border:none;" readonly="true" />&nbsp;:&nbsp;
																								<input name="weighChallanNo" type="text" id="weighChallanNo" size="8" value="<?=$recordWeighNo?>" tabindex="7" onkeypress="return focusNextBox(event,'document.frmDailyCatch','selectDate');" onchange="xajax_chkValidCNum(document.getElementById('billingCompany').value, document.getElementById('weighChallanNo').value, document.getElementById('selectDate').value, document.getElementById('entryId').value, '<?=$mode?>');" autocomplete="off"  />
																			</td>
																		</tr>
																		<tr>
														...
														<div style="width: 900px; height: 400px; overflow-x: scroll; overflow-y: scroll; scrollbar-arrow-color:blue; scrollbar-face-color: #e7e7e7; scrollbar-3dlight-color: #a0a0a0; scrollbar-darkshadow-color:#888888;" id="catchentrygrosswt">
															...
															<?//=($id+$num);?>
																	...
																	?>
																				...
																				<input type="hidden" name="hidRowCount" id="hidRowCount" value="<?=$id?>" /></td>
																			...
																			<tr><td colspan="3" class="fieldName1" style="text-align:left;" nowrap>Net:<span class="listing-item"><input type="text" size="3" name="netWt_<?=$i?>" id="netWt_<?=$i?>" style="border:none; text-align:right; background-color::#D0DAFD;" readonly value="<?=($netWt!=0)?number_format($netWt,2,'.',''):"";?>" />&nbsp;Kg</span></td></tr>
																		  </table>
																			...
																			<tr>
																				<td>
																					<table border="0">
																						...
																						<tr><td><table width="100%" cellspacing="1" bgcolor="#999999" cellpadding="2" id="tblQuality" name="tblQuality">
																						...
																						<!-- Local Wastage section ends here  -->
																						<tr>
																					...
																					<table>
																						<tr><td>
																						  <table>
																							...
																							?>
																									<textarea name="entryRemark" cols="23" rows="4" id="entryRemark" tabindex="29" onkeypress="return focusNextBox(event,'document.frmDailyCatch','cmdAddRaw');"><?=$recordRemarks?></textarea></td>
																							  </tr>
																						  </table>	
																						  </td>
																						</tr>
...
<TD align="left">
 <table cellspacing="0" align="left" cellpadding="0" width="60%">
	...
	?>
    <!--<tr> 
      <td align="center" class="listing-item" valign="top"><img src="images/x.gif" width="20" height="20"> - These Transactions are incomplete.</td>
    </tr>-->
    <tr> 
      <td > 
	<table cellpadding="0"  cellspacing="0" border="0" align="center"  width="90%"  bgcolor="#D3D3D3">
          <tr> 
            <td   bgcolor="white"  width="100%"> 
              <!-- Form fields start -->
              <!--table cellpadding="1"  width="80%" cellspacing="0" border="0" align="center" >
		<tr>
			<td colspan="2" width='100%'><img src="images/bl.gif" width='100%' height='4px' >
			</td>
		</tr-->
		...
		<table width='100%'>
                <!--tr> 
                  <td  colspan="2" class="pageName" nowrap  valign="top" width="475px">DAILY RAW MATERIAL ENTRY</td>					
                </tr-->
                <tr>
		...
		?>
			...
			<?php
				...
				require("template/rbTop.php");
			?>
			<!--<table width="100%" cellpadding="0" cellspacing="0"><TR bgcolor="White"><TD class="rBoxHead">Add New RM In Challan</TD></TR></table>-->
			<!--<span class="rBoxHead">Add New RM In Challan</span>-->
			<!--<fieldset style="padding:10 10 10 10px;">
                        <legend class="listing-item">Add New RM In Challan</legend>-->
		...
		?>
                ...
                <tr> 
                  <td colspan="4"> <table cellpadding="0" cellspacing="0" align="center">
                      <tr> 
	...
	<? }?>
                  ...
                  <td colspan="4"> <table cellpadding="0" cellspacing="0" align="center">
                      <tr> 
                        <td><? if($del==true){?><input type="submit" value=" Delete " class="button"  name="cmdDelete" onClick=" return confirmDelete(this.form,'delId_',<?=$catchEntryRecSize?>);" ><? }?>
                         ...
                         <? if($add==true){?> <input type="submit" value=" Add New " name="cmdAddNew" class="button"><? }?>
                          &nbsp;<? if($print==true){?>
                          <input type="button" value=" Print " name="btnPrint" class="button" onClick="return printWindow('PrintDailyCatch.php?supplyFrom=<?=$dateFrom?>&supplyTill=<?=$dateTill?>&supplyTill=<?=$dateTill?>&supplier=<?=$selSupplierId?>&selFish=<?=$selFish?>&selProcesscode=<?=$selProcesscode?>&selRecord=<?=$selRecord?>',700,600);"><? }?></td>
                      </tr>		
                    </table></td>
                </tr>
                <tr> 
		...
		<!--tr>
		<td colspan="2" width='100%'><img src="images/bl.gif" width='100%' height='1px' >
		</td>
	</tr-->
              </table>
	<?
