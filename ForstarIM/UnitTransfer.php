<?
	...
	if ($p["cmdAdd"]!="" ) {
		...
		$firstLotId		=	$p["firstLotId"];
		$lotId		=	$p["lotId"];
		
		
		
		if ($rmlotId!="" ) {	
			$unitTransferRecIns	=	$unitTransferObj->addUnitTransfer($rmlotId, $supplierDetails, $currentUnitName, $currentProcessingStage, $unitName,$processType,$lotId ,$firstLotId,$userId);
	...
	if ($p["cmdSaveChange"]!="") {		
		...
		if ($unitTransferDataId!="" && $rmlotId!="" && $supplierDetails!="" && $currentUnitName!="" && $currentProcessingStage!="" && $unitName!="" && $processType!="" && $lotId!="" ) {
			$unitTransferDataRecUptd	=	$unitTransferObj->updateUnitTransfer($unitTransferDataId, $rmlotId, $supplierDetails,$currentUnitName,$currentProcessingStage,$unitName,$processType,$lotId,$firstLotId);
								...
								<tr>
									...
									<td colspan="2" >
										<table cellpadding="0"  width="95%" cellspacing="0" border="0" align="center">
											...
											<tr>
												<td colspan="2" nowrap class="fieldName" height="30px" >
												</td></tr>
											<tr>
			...
			<table width="100%" align="center">
				...
				<?php							
					...
					<table cellpadding="0"  cellspacing="1" border="0"   width="100%"  align="center">
							...
							<tr>
							   <td class="fieldName" nowrap>*Weightment Challan Number:</td>
				...
				<?php							
					...
					<table cellpadding="0"  cellspacing="1" border="0"   width="100%"  align="center">
							...
							<tr>
							   ...
							   <td><INPUT TYPE="HIDDEN" NAME="firstLotId" id="firstLotId" size="15" value="<?=$firstLotId?>"></td>
...
<? if($maxpage>1){?>
	...
	<tr  bgcolor="#f2f2f2" >
		...
		<td class="listing-head" align="center" style="padding-left:10px; padding-right:10px;">Weightment Challan Number</td>
		<td class="listing-head" style="padding-left:10px; padding-right:10px;">Old Unit name</td>
		<td class="listing-head" style="padding-left:10px; padding-right:10px;">Old Processing Stage</td>
