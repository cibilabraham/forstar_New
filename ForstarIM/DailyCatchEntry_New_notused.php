																			...
																			<table align="center" cellpadding="0" cellspacing="0">
																				<tr>
																					...
																					<td nowrap>
																						...
																						?>
																						<select name="billingCompany" id="billingCompany" onchange="xajax_getBillingCompanyRec(document.getElementById('billingCompany').value); xajax_chkValidCNum(document.getElementById('billingCompany').value, document.getElementById('weighChallanNo').value, document.getElementById('selectDate').value, document.getElementById('entryId').value,document.getElementById('unit').value, '<?=$mode?>'); xajax_chkValidDate(document.getElementById('selectDate').value, document.getElementById('billingCompany').value, '<?=$mode?>'); xajax_getChallanDetails(document.getElementById('unit').value,document.getElementById('billingCompany').value);  xajax_getUnit(this.value,'','');">
																							<option value="">--Select--</option>
																							<?php
...
?>
    <tr> 
		<td height="10" bgcolor="#fff">
			...
			<input type="text" name="entryId" id="entryId" value="<?=$lastId?>" readonly="true">		
			<input type="text" name="catchEntryNewId" id="catchEntryNewId" value="<?=$catchEntryNewId;?>" readonly="true">
