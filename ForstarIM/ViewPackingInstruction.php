...
<table width="99%" cellpadding="2" cellspacing="0" bgcolor="#CCCCCC"  >
 <tr bgcolor=white>
	...
	<table width="200" cellpadding="3">
	 ...
	 <tr valign="top">
        <td class="listing-item" nowrap="nowrap" valign="top" style="line-height:normal;"><?=$mcDoneBy?></td>
        <td class="listing-item" nowrap="nowrap" valign="top">&nbsp;</td>
        <td class="listing-item" nowrap="nowrap" valign="top" style="line-height:normal;"><?=$verifiedBy?></td>
      </tr>	
    </table></td>
  </tr>	
  <tr bgcolor="White">
