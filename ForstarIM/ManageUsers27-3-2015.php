<?php
	...
	if ($p["cmdAddUser"]!="") {
		...
		if ($addUserName!="" && $addUserPassword!="" && $selRole!="") {
			...
			$userRecIns	=	$manageusersObj->addUser($addUserName,$PWord,$selRole);
	...
	if ($p["cmdSaveChange"]!="") {
		...
		if ($upUserName!="" && $upUserPassword!="" && $selRole!="" && $userEditId!="") {
			...
			$userRecUptd	=	$manageusersObj->updateUser($upUserName,$PWord,$selRole,$userEditId);
		}
								...
								<tr> 
									...
									<td colspan="2" > 
										<table cellpadding="0"  width="90%" cellspacing="0" border="0" align="center">
											...
											<tr id="rowUser" style="display:none">
