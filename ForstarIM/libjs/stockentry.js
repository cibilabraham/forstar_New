	...
	{		
		...
		{	
			...
			if (companyId=="0") 
			{
				...
				//packingkg.focus();
				//document.getElementById("company_"+i).focus();
				return false;
			}
...
function addNewPOItem2(tableId,selCompanyId,selFishId, selProcessCodeId, selFreezingStageId, selFrozenCodeId, selMCPackingId,selGradeId,numMC,cpyItem,mode)
{
	...
	var companyId	= "<select name='companyId_"+fieldIdStock+"' id='companyId_"+fieldIdStock+"' onchange=\"xajax_getUnit(document.getElementById('companyId_"+fieldIdStock+"').value,'"+fieldIdStock+"','');\"><option value='0'>--Select--</option>";
