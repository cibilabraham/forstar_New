...
{		
	...
	//var registrationNumber=form.registrationNumber.value;
	...
	/*if (registrationNumber=="") {
		 alert("Please select Registration Number.");
		 form.registrationNumber.focus();
		 return false;
	 }*/
	 

	//********************validation for equipment and chemical******************************//
...
//********************add multiple row for equipment ******************************//
...
//********************validation for duplicate entry for equipment ******************************//
/*var cArr = new Array();
var cArri = 0;	
...
//********************validation for duplicate entry for chemical ******************************//
/*var cArr1 = new Array();
var cArri1 = 0;
