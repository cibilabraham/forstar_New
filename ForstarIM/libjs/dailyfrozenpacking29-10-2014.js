...
function calcProdnQtyLS()
	{
		var slabTotal=0; var qtyTotal=0; var gradeId=""; var lsPkgGroupArr 	= new Array(); var EntryId = new Array(); var mc=''; var ls='';
		//alert("hii");
		var LSToMCConversionType   = document.getElementById("hidLS2MCType").value;
		var prodnRowCount 	= document.getElementById("hidProdnRowCountCvt").value;
		var gradeRowCount = document.getElementById("hidGradeRowCountCvt").value;
...
function addMCForConvert(tableId,rmId,mcPkgId,gradeIdAll,gradeAll,mode)
{
	//alert("hii--jii");
	//alert(gradeIdAll);
	//alert(gradeAll);
	...
	alert(grdAr[l]);
		...
		var tbl		= document.getElementById(tableId);
			...
			// for(l=0; l<grdlen; l++)
			// {
				// var "cell"+m= row.insertCell(parseInt(m)-1);
			// m++;
			// }
			cell1.id = "srNo_"+fdId;		
			cell1.className	= "listing-item"; cell1.align	= "center";
			...
			var rmlot	= "<select name='rmlotId_CnvrtLs_"+fdId+"' id='rmlotId_CnvrtLs_"+fdId+"'  ><option value='0'>--Select--</option>";
						<?php
			...
			var mcPack	= "<select name='mcPackingIdCnvrtLs_"+fdId+"' id='mcPackingIdCnvrtLs_"+fdId+"'  ><option value='0'>--Select--</option>";
						   <?php
			...
			?>
				if (mcPkgId=="<?=$mcPkgId?>")  var sel = "Selected";
				else var sel = "";
			...
			cell3.innerHTML	= mcPack;
			//cell2.innerHTML	= Qty;	
			cell4.innerHTML	='';
			cell5.innerHTML	= "<input name='gradeQty_1"+fdId+"' type='text' id='gradeQty_1"+fdId+"' size='5' readonly style='text-align:right; border:none;' tabindex="+fdId+"  value=''>";
			cell6.innerHTML	= "<input name='gradeQty_2"+fdId+"' type='text' id='pondQty_2"+fdId+"' size='5' readonly style='text-align:right; border:none;' tabindex="+fdId+"  value=''>";
			cell7.innerHTML	= "<input name='gradeQty_3"+fdId+"' type='text' id='gradeQty_3"+fdId+"' size='5' readonly style='text-align:right; border:none;' tabindex="+fdId+"  value=''>";
			cell8.innerHTML	= "<input name='gradeQty_4"+fdId+"' type='text' id='gradeQty_4"+fdId+"' size='5' readonly style='text-align:right; border:none;' tabindex="+fdId+"  value=''>";
			cell9.innerHTML	= "<input name='gradeQty_5"+fdId+"' type='text' id='gradeQty_5"+fdId+"' size='5' readonly style='text-align:right; border:none;' tabindex="+fdId+"  value=''>";
			cell10.innerHTML	= "<input name='gradeQty_6"+fdId+"' type='text' id='gradeQty_6"+fdId+"' size='5' readonly style='text-align:right; border:none;' tabindex="+fdId+"  value=''>";
			cell11.innerHTML	= "<input name='gradeQty_7"+fdId+"' type='text' id='gradeQty_7"+fdId+"' size='5' readonly style='text-align:right; border:none;' tabindex="+fdId+"  value=''>";
			cell12.innerHTML	= "<input name='gradeQty_8"+fdId+"' type='text' id='gradeQty_8"+fdId+"' size='5' readonly style='text-align:right; border:none;' tabindex="+fdId+"  value=''>";
			cell13.innerHTML	= "<input name='gradeQty_9"+fdId+"' type='text' id='gradeQty_9"+fdId+"' size='5' readonly style='text-align:right; border:none;' tabindex="+fdId+"  value=''>";
			cell14.innerHTML	= "<input name='gradeQty_10"+fdId+"' type='text' id='gradeQty_10"+fdId+"' size='5' readonly style='text-align:right; border:none;' tabindex="+fdId+"  value=''>";
			cell15.innerHTML	= "<input name='gradeQty_11"+fdId+"' type='text' id='gradeQty_11"+fdId+"' size='5' readonly style='text-align:right; border:none;' tabindex="+fdId+"  value=''>";
			cell16.innerHTML	= "<input name='gradeQty_12"+fdId+"' type='text' id='gradeQty_12"+fdId+"' size='5' readonly style='text-align:right; border:none;' tabindex="+fdId+"  value=''>";
