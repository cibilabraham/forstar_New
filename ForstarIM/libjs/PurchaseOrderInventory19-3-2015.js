...
function addNewStockItemRow(tableId, poItem, selStockId, qty, totalAmt, supplierRateListId, mode,selPlantId,notOver,description,unitprice,prindesc,stkQty)
{
	...
	var selectStock	= "<select name='selStock_"+fieldId+"' id='selStock_"+fieldId+"' onchange=\"getAllRecords('"+fieldId+"',"+supplierSelected+",document.getElementById('selStock_"+fieldId+"').value,document.getElementById('selPlant_"+fieldId+"').value),'<?=$poItem?>','"+supplierRateListId+"', '"+mode+"';\">";
	var sel;
	...
	var selectPlant	= "<select name='selPlant_"+fieldId+"' id='selPlant_"+fieldId+"' onchange=\"getAllUnitRecords('"+fieldId+"',document.getElementById('selStock_"+fieldId+"').value,document.getElementById('selPlant_"+fieldId+"').value);\">";
	<?php
	...
	cell3.innerHTML	= "<input name='unitPrice_"+fieldId+"' type='text' id='unitPrice_"+fieldId+"' value='"+unitprice+"' size='6' style='text-align:right' readonly>";
	cell4.innerHTML	= "<input name='quantity_"+fieldId+"' type='text' id='quantity_"+fieldId+"' value='"+qty+"' size='6' style='text-align:right' autoComplete='off' onKeyUp=\"return multiplyPOItem(document.frmPurchaseOrderInventory,'<?=$poItem?>');\" onchange=\"xajax_chkStockItemOrderQty(document.getElementById('selStock_"+fieldId+"').value, "+fieldId+",document.getElementById('quantity_"+fieldId+"').value, '"+mode+"');\"><input name='hidSelStock_"+fieldId+"' type='hidden' id='hidSelStock_"+fieldId+"' readonly value='"+selStockId+"'>"+hiddenFields+"<input name='hidStockStatus_"+fieldId+"' type='hidden' id='hidStockStatus_"+fieldId+"'> <span id='orderQtyDivId_"+fieldId+"' style='line-height:normal; font-size:10px; color:red;'></span>";
...
//document.getElementById("showSuppliersRow").style.display="block";
