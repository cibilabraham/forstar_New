	...
	var supplierCount	=	document.getElementById("hidSupplierRowCount").value;
		...
		for (i=0; i<supplierCount; i++)
		{
		   var status = document.getElementById("sstatus_"+i).value;		    
			...
			var locationName		=	document.getElementById("location_"+i);
			...
			{
				alert("Please Select a Location Name.");
				locationName.focus();
				return false;
			}
...
function addNewRMProcurmentSupplierRow(tableId,editProcurmentId,supplierName1, supplierGroup,pondName1,pondLocation,pondQty,mode)
{
   ...
   <? }
	...
	cell4.innerHTML	= "<select name='location_"+fieldvalue+"' id='location_"+fieldvalue+"' ><option>--select--</option></select>";
...
/*function addNewRMProcurmentSupplierRow(tableId,editProcurmentId,supplierName1, supplierGroup,pondName1,pondLocation,pondQty,mode)
{
	...
	cell2.className	=	"fieldName"; cell2.align = "center";
	cell3.className	=	"fieldName"; cell3.align = 'center';
	cell4.className	=	"fieldName"; cell4.align = "center"; cell4.style.display = "none"; cell4.id="farm_"+fieldvalue;
	cell5.className	=	"fieldName"; cell5.align = "center"; cell5.id="land_"+fieldvalue;
	cell6.className	=	"fieldName"; cell6.align = "center";
...
?>	
	...
	cell5.innerHTML	= "<select name='location_"+fieldvalue+"' id='location_"+fieldvalue+"' ><option>--select--</option></select>";
	cell6.innerHTML	= "<input name='pondQty_"+fieldvalue+"' type='text' id='pondQty_"+fieldvalue+"' size='15' readonly style='text-align:right; border:none;' tabindex="+fieldvalue+"  value='"+pondQty+"'>";
...
function checkProcurementOrder(gatePass)
{
	if(gatePass!="")
	{
		...
		if(n.match(str))
		{
			...
			document.getElementById('procurmentNo').value = newGatePass;
			xajax_checkProcurementOrder(newGatePass);
			enableButton();
		}
		else
		{
			alert("Invalid format for procurement number");
			disableButton();
		}
	}
}
