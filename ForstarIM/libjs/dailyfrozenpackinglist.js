...
function callPkgChangeFr(ffrozId)
{
	//alert("hai1");
	setTimeout("calcPkgChangeFr("+ffrozId+")",500);
	
}



function calcPkgChangeFr(ffrozId,ffilledWt)
{
	//alert("fr");
	...
	{	
		...
		document.getElementById("numLS_"+i+"_"+rowId).value=existLSi;
		...
		if (totalSlabsi>0)
		{			
			//alert("Total Slabsi"+totalSlabsi);
			var iwet=totalSlabsi*filledWt;
			//alert("iwet"+iwet);
...
function calcPkgChangeFr_2(ffrozId,ffilledWt)
{
	alert("fr");
	var ifrozId=parseFloat(document.getElementById("finfrozenCode").value);
	var filledWt=parseFloat(document.getElementById("filledWt").value);
	...
	{	
		...
		{			
			...
			var totLS=Math.floor(existingMCi*numMCPackUsedi)%numMCPackUsed;
					...
					alert("hello1");
			var totMC=Math.floor(iwet/fwet);
			totMC=totMC*numMCPackUsedi/numMCPackUsed;
			var totLS=parseInt(iwet)%parseInt(fwet);
			}
			//var totMC	 = Math.floor(totalSlabs/numMCPack);
			//var totLS	 = parseInt(totalSlabs)%parseInt(numMCPack);
...
function calcPkgChangeFr_1(ffrozId,ffilledWt)
{
	//alert("fr");
	var ifrozId=parseFloat(document.getElementById("finfrozenCode").value);
	var filledWt=parseFloat(document.getElementById("filledWt").value);
	...
	{	
		...
		{			
			...
			var fwet=totalSlabs*parseFloat(ffilledWt);
