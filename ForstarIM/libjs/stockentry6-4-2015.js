...
function addNewPOItem2(tableId,selCompanyId,selFishId, selProcessCodeId, selFreezingStageId, selFrozenCodeId, selMCPackingId,selGradeId,numMC,cpyItem,mode)
{
	...
	var companyId	= "<select name='companyId_"+fieldIdStock+"' id='companyId_"+fieldIdStock+"' onchange=\"getPackValue('"+fieldIdStock+"');\"><option value='0'>--Select--</option>";
	...
	?>	
		if (selCompanyId== "<?=$companyId?>")  var sel = "Selected";
		else var sel = "";
