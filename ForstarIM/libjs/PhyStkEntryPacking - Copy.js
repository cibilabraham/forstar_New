	...
	{	
		...
		for (i=0; i<rc; i++) {
			...
			if (status!='N') {
				...
				var addVal = fish+""+processCode+""+selGrade+""+freezingStage+""+frozenCode+""+mCPacking;
...
cell8.innerHTML = "<input type='text' name='numMC_"+fieldId+"' id='numMC_"+fieldId+"' size='6' value='"+numMC+"' onkeyup='totRowVal("+fieldId+");' style='text-align:right;'>";
cell9.innerHTML = "<input type='text' name='numLS_"+fieldId+"' id='numLS_"+fieldId+"' size='6' value='"+numLS+"' onkeyup='totRowVal("+fieldId+");' style='text-align:right;'>";
cell10.innerHTML = imageButton+hiddenFields+hidOtherFields;	
