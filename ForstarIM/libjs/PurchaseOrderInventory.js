...
function addNewStockItemRow(tableId, poItem, selStockId, qty, totalAmt, supplierRateListId, mode,selPlantId,notOver,description,unitprice,prindesc,stkQty,excise,exciserate,vat,vatrate)
{
	//alert("poItem"+poItem);
	var chkexciseS=""; var chkexciseN=""; var chkexciseNA=""; 
	...
	else
	{
		...
		if(excise==2)
		{
			var chkexciseN='checked';
		}
		else if(excise==3)
		{
			var chkexciseNA='checked';
		}
	}
	...
	else
	{
		...
		{
			var chkvatNA='checked';
		}
	}

	//alert(exciserate);
	cell12.innerHTML="<table><tr><td class='listing-head'>Excise</td><td class='fieldName' nowrap>YES <input type='checkbox' name='exciseS_"+fieldId+"' id='exciseS_"+fieldId+"' value='1' class='excise_"+fieldId+"' onclick=\"fieldDispExcise('"+fieldId+"',document.getElementById('exciseS_"+fieldId+"').value,'exciseS');\" "+chkexciseS+" /></td><td class='fieldName' nowrap>NO <input type='checkbox' name='exciseN_"+fieldId+"' id='exciseN_"+fieldId+"' value='2' class='excise_"+fieldId+"' onclick=\"fieldDispExcise('"+fieldId+"',document.getElementById('exciseN_"+fieldId+"').value,'exciseN');\" "+chkexciseN+" /></td><td class='fieldName' nowrap>NA<input type='checkbox' name='exciseNA_"+fieldId+"' id='exciseNA_"+fieldId+"' value='3' class='excise_"+fieldId+"' onclick=\"fieldDispExcise('"+fieldId+"',document.getElementById('exciseNA_"+fieldId+"').value,'exciseNA');\"  "+chkexciseNA+" /><td class='fieldName' nowrap><input type='textbox' name='excisePercentage_"+fieldId+"' id='excisePercentage_"+fieldId+"' value='"+exciserate+"' size='10' "+style+" /></td></td></tr><tr><td class='listing-head'>Vat</td><td class='fieldName' nowrap>YES <input type='checkbox' name='vatS_"+fieldId+"' id='vatS_"+fieldId+"' value='1'' class='vat_"+fieldId+"' onclick=\"fieldDispVat('"+fieldId+"',document.getElementById('vatS_"+fieldId+"').value,'vatS');\" "+chkvatS+"/></td><td class='fieldName' nowrap>NO <input type='checkbox' name='vatN_"+fieldId+"' id='vatN_"+fieldId+"' value='2' class='vat_"+fieldId+"' onclick=\"fieldDispVat('"+fieldId+"',document.getElementById('vatN_"+fieldId+"').value,'vatN');\" "+chkvatN+"/></td><td class='fieldName' nowrap>NA<input type='checkbox' name='vatNA_"+fieldId+"' id='vatNA_"+fieldId+"' value='3' class='vat_"+fieldId+"' onclick=\"fieldDispVat('"+fieldId+"',document.getElementById('vatNA_"+fieldId+"').value,'vatNA');\" "+chkvatNA+"/></td><td class='fieldName' nowrap><input type='textbox' name='vatPercentage_"+fieldId+"' id='vatPercentage_"+fieldId+"' value='"+vatrate+"' size='10' "+style1+"/></td></tr></table>";
	cell13.innerHTML = imageButton;
	if(mode=="2")
	{	
...
function fieldDispExcise(fld,fldValue,fieldName)
{
	//alert(fld+','+fldValue);
	if($("#"+fieldName+"_"+fld).attr("checked")==true)
	{
		$(".excise_"+fld).attr("checked",false);
		$("#"+fieldName+"_"+fld).attr("checked",true);
		if(fldValue==1)//yes
		{
			$("#excisePercentage_"+fld).show();
		}
		else
		{
			$("#excisePercentage_"+fld).hide();
		}
	}
	else
	{
...
function fieldDispVat(fld,fldValue,fieldName)
{
	//alert(fld+','+fldValue+','+fieldName);
	if($("#"+fieldName+"_"+fld).attr("checked")==true)
	{
		$(".vat_"+fld).attr("checked",false);
		$("#"+fieldName+"_"+fld).attr("checked",true);
		if(fldValue==1)//yes
		{
			$("#vatPercentage_"+fld).show();
		}
		else
		{
			$("#vatPercentage_"+fld).hide();
		}
	}
	else
	{
