...
var tbl		= document.getElementById(tableId);
	...
	//cell6.className	= "listing-item"; cell6.align	= "center";
		...
		//alert("entered");
		//alert("<?=$vehileTypeId?>");
		var qualityName	= "<select name='qualityId_"+fldId+"' id='qualityId_"+fldId+"' onchange=\"xajax_getQualityDet(document.getElementById('qualityId_"+fldId+"').value,"+fldId+");\" ><option value='0'>--Select--</option>";
		if(qualitys!="")
		{
			for(i=0;i< len; i++)
			{
	...
	cell3.innerHTML	="<input name='qualityWeight_"+fldId+"' type='text' id='qualityWeight_"+fldId+"' size='5' onkeyup='return effectiveWtNew();' value=''  />Kg";
	cell4.innerHTML	="Reason<input name='qualityReason_"+fldId+"' type='text' id='qualityReason_"+fldId+"' size='20' value='' autocomplete='off'/>";
...
{
	var lot=document.getElementById('lotIdAvailable').value;
	if(lot!='')
	{
		if(document.getElementById('lotIdAvailable').checked)
		{
