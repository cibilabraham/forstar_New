<?php
	...
	#Using in Advance and Quick Search
		$dailyCatchSummaryRecords = $dailycatchsummaryObj->filterDailyCatchSummaryRecords($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate, $dateSelectFrom, $billingCompany,$viewType);
	
	#process-Count-Summary
		$processCountSummaryRecords = $dailycatchsummaryObj->filterProcessCountSummaryRecords($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate, $dateSelectFrom, $billingCompany,$viewType);
	
	#For Selecting Fish - Process - Summary
		$processSummaryRecords = $dailycatchsummaryObj->filterFishProcessSummaryRecords($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate, $dateSelectFrom, $billingCompany,$viewType);
	
	#For Selecting Fish - Catch - Summary
		$fishWiseCatchSummaryRecords =	$dailycatchsummaryObj->filterFishWiseCatchSummaryRecords($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate, $billingCompany,$viewType);
	
	#Wt Challan Summary 
		$wtChallanWiseSummary = $dailycatchsummaryObj->filterWtChallanRecords($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate, $billingCompany,$viewType);
	...
	$declaredWtRecords  = $dailycatchsummaryObj->getSupplierDeclaredWtRecords($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate, $dateSelectFrom, $billingCompany,$viewType);

#For declared wt sheet
	# For Listing
	$supplierWiseDeclaredRecords = $dailycatchsummaryObj->getSupplierWiseDeclaredRecords($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate, $dateSelectFrom, $billingCompany,$viewType);
	
	$processCountWiseDeclaredRecords = $dailycatchsummaryObj->getProcessCountWiseDeclaredRecords($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate, $dateSelectFrom, $billingCompany,$viewType);

	if ($RMMatrix) {
	#RM Summary Matrix
		$RMChallanWiseRecords 	= $dailycatchsummaryObj->groupWtChallanRecords($fromDate, $tillDate, $selectUnit, $landingCenterId, $selectSupplier, $fishId, $processId, $selectADate, $billingCompany,$viewType);
	
		$rmSummaryMatrixRecords = $dailycatchsummaryObj->filterRMSummaryMatrixRecords($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate, $dateSelectFrom, $billingCompany,$viewType);
	}

	#For getting the local qty Report
	if ($localQtyReportChk) {
		$dailyCatchReportResultSetObj = $dailycatchsummaryObj->filterDailyCatchEntryRecords($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate,  $billingCompany,$viewType);
		$dailyCatchReportRecords = $dailyCatchReportResultSetObj->getNumRows();
	}

	#For getting the Daily Summary View
	if ($dailySummary) {
		$dailySummaryResultSetObj = $dailycatchsummaryObj->filterDailySummaryRecords($fromDate, $tillDate, $selectADate, $billingCompany,$viewType);
	...
	if ($RMRateMatrix) {
		...
		$rmSupplierRecords = $dailycatchsummaryObj->fetchRMSupplierRecords($fromDate, $tillDate, $landingCenterId, $selectUnit, $selectADate, $dateSelectFrom, $selectSupplier, $fishId, $processId, $billingCompany,$viewType);
	...
	# Qty Wise Summary
	if ($qtySummaryChk) {
		$wtChallanQtySummaryRecs = $dailycatchsummaryObj->fetchWtChallanQtyRecs($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate, $billingCompany,$viewType);
	}

	# Challan Wise Summary
	if ($challanSummaryChk) {
		$challanQtyWiseSummaryRecs = $dailycatchsummaryObj->fetchChallanWiseRecs($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate, $billingCompany,$viewType);
	}
...
if ($p["cmdAdvSearch"]!="") {
	...
	$selectedTableHeader[22]	=	$p["rmlotid"];
	...
	if($p["date"]=="" && $p["wtChallanNo"]=="")
	{
		$dailyCatchSummaryRecords = $dailycatchsummaryObj->getAdvanceSearchGroupRecords($selectUnit, $landingCenterId, $selectSupplier, $fromDate, $tillDate, $fishId, $processId, $selectADate, $billingCompany,$viewType);
	}
					...
					<tr>
						<td   bgcolor="white">
							...
							<table cellpadding="0"  width="100%" cellspacing="0" border="0" align="center">
														...
														<tr> 
															...
															<td valign="top">
																...
																<tr>
																	...
																	<td>
																		<select name="viewType" id="viewType"  onchange="functionLoad(this);">
																			<option value="">--Select--</option>
														...
														<table width="200" border="0">
															...
															<tr>
																...
																<td>
																	<table width="50" border="0">
																		<tr>
																			<td align="center"><input name="rmlotid" type="checkbox" id="rmlotid" value="RMLotId" <?=$rmlotid?> class="chkBox"></td>
																			<td class="listing-item" nowrap>RM Lot Id </td>
																		</tr>
																	</table>
																</td>
																<? } ?>
													...
													<?
														...
														for($k=0;$k<$arraySize;$k++){
															...
															<td class="listing-item" style="padding-left:3px; padding-right:3px;" <?=$alignStyle?>>
																...
																if($tHeader=="RMLotId") echo $rmlotName;
																?>							
															</td>
															<? 
															}
										...
										<tr bgcolor="#FFFFFF"> 
											<td colspan="17" align="left" class="listing-head"> 
												<table width="95%" border="0" cellspacing="1" cellpadding="0" bgcolor="#999999">
													<tr bgcolor="#f2f2f2" align="center">
														<? if($viewType=="lot") { ?>
														<td class="listing-head" style="padding-left:3px; padding-right:3px;" nowrap>RM Lot Id</td>
														<? } ?>
												...
												<tr  <? if($rateNAmount) { if ($selamt>0){?> bgcolor="#FFFFFF" <?php } else {?> bgcolor="#e0f1fe" <?php }} else {?> bgcolor="#FFFFFF"  <?php }?>>
													<? if($viewType=="lot") { ?>
													<td class="listing-item" style="padding-left:3px; padding-right:3px;"><?=$rmlotName?></td>
													<? } ?>
												...
												?>
												<tr bgcolor="#FFFFFF">
													<? ($viewType=="lot")? $colspan="9":$colspan="8"?>
													<td colspan="<?=$colspan?>" align="right" nowrap class="listing-item"><span class="listing-head">TOTAL:</span>&nbsp;&nbsp;</td>
									...
									<tr bgcolor="#FFFFFF">
										<td colspan="17" align="left" class="listing-head">
											...
											?>
												...
												<? }  ?>
												<tr bgcolor="#FFFFFF">
													<? ($viewType=="lot")? $colspan="5":$colspan="4"?>
													<td colspan="<?=$colspan?>" class="listing-item" align="right"><span class="listing-head">TOTAL</span>&nbsp;&nbsp;</td>
								...
								<tr bgcolor="#FFFFFF"> 
									<td colspan="16" align="left" class="listing-head">
										...
										?>
											...
											<tr bgcolor="#f2f2f2" align="center"> 
												<? if($viewType=="lot") { ?>
												<td class="listing-head" style="padding-left:10px; padding-right:10px;">RM Lot Id</td>
												<? } ?>
												<td class="listing-head" style="padding-left:10px; padding-right:10px;">Fish</td>
												<td class="listing-head" style="padding-left:10px; padding-right:10px;">Process Code</td>
												<td class="listing-head" style="padding-left:10px; padding-right:10px;">Effective Wt </td>
											...
											?>
											<tr bgcolor="#FFFFFF">
												<? ($viewType=="lot")? $colspan="3":$colspan="2"?>
												<td colspan="<?=$colspan?>" nowrap class="listing-head" align="right">TOTAL&nbsp;&nbsp;</td>
												<td class="listing-item" align="right" nowrap="nowrap"><strong> 
												  <? echo number_format($totalWt,2);?>
												  </strong>&nbsp;&nbsp;
												</td>
								...
								<tr><td colspan="17">
									...
									?>
									<tr bgcolor="#FFFFFF">
										<?($viewType=="lot")?$colspan="2":$colspan="1"?>
										<td colspan="<?=$colspan?>" nowrap class="listing-item" align="right"><span class="listing-head">TOTAL</span>&nbsp;&nbsp;</td>
										<td class="listing-item" align="right" nowrap="nowrap"><strong> 
											<? echo number_format($totalWt,2);?>
											</strong>&nbsp;&nbsp;</td>
										   <? if($rateNAmount) {?>
						...
						<tr>
							...
							?>
								<table width="50%" border="0" cellspacing="1" cellpadding="0" bgcolor="#999999">
									...
									?>
									<tr bgcolor="#FFFFFF">
										<? ($viewType=="lot")? $colspan="8":$colspan="7"?>
										<td colspan="<?=$colspan?>" align="right" nowrap class="listing-head">TOTAL :&nbsp;&nbsp;</td>
						...
						<tr>
							...
							<table width="55%" border="0" cellspacing="1" cellpadding="0" bgcolor="#999999">
								<tr bgcolor="white"> 
									<? ($viewType=="lot")? $colspan="5":$colspan="6"?>
									<td colspan="<?=$colspan?>" align="center" class="listing-head">Fish-Process Code-Grade/Count-Declared Wt -Summary</td>
                                </tr>
								<tr bgcolor="#f2f2f2">
									<? if($viewType=="lot") { ?>
									<td class="listing-head" style="padding-left:10px; padding-right:10px;" nowrap>RM Lot Id</td>
								...
								<tr bgcolor="#FFFFFF"> 
								  ...
								  ?>
								<tr bgcolor="#FFFFFF">
									<? ($viewType=="lot")? $colspan="4":$colspan="3"?>
					...
					<tr>
						<td colspan="17">
							<table width="55%" border="0" cellspacing="1" cellpadding="0" bgcolor="#999999">
								...
								<? ($viewType=="lot")?$columnSize=$columnSize+1:$columnSize=$columnSize;?>
                                <tr bgcolor="white"> 
                                ...
                                <tr bgcolor="#f2f2f2" align="center"> 
								  ...
								  foreach($supplierWiseDeclaredRecords as $ssr) {
									...
									<tr bgcolor="#FFFFFF">
										<? ($viewType=="lot")? $colspan="3":$colspan="2"?>
										<td colspan="<?=$colspan?>" align="right" nowrap class="listing-head" style="padding-left:5px; padding-right:5px;">TOTAL DECL WT:</td>
										<?
										$grandTotalDeclWt = "";
										foreach($processCountWiseDeclaredRecords as $ssr)
										{
					...
					<? ($viewType=="lot")? $columnSize=$columnSize+1:$columnSize=$columnSize?>	
                        ...
                        <tr bgcolor="#f2f2f2" align="center">
                          ...
                          <?
							...
							<tr bgcolor="#FFFFFF">
								<? ($viewType=="lot")? $colspan="3":$colspan="2"?>
                               <td colspan="<?=$colspan?>" align="right" nowrap class="listing-head" style="padding-left:5px; padding-right:5px; line-height:normal; font-size:11px;">TOTAL  WT:</td>
                               <?
								foreach($rmSummaryMatrixRecords as $pcsr)
								{
				...
				<tr>
					<TD>
						<table width="99%" cellpadding="2" cellspacing="1" bgcolor="#999999" align="center">
							<tr bgcolor="#f2f2f2" align="center">
								<? if($viewType=="lot") { ?>
								<th class="listing-head" style="padding-left:2px; padding-right:2px; font-size:7pt" nowrap>RM Lot Id</td>
								<? } ?>
							...
							<tr <? if($rateNAmount) { if ($actualRate>0){?> bgcolor="#FFFFFF" <?php } else {?> bgcolor="#e0f1fe" <?php }} else {?> bgcolor="#FFFFFF"  <?php }?>>
								<? if($viewType=="lot") { ?>
								<td class="listing-item" nowrap style="padding-left:2px; padding-right:2px; font-size:7pt;" align="center">
								<?=$rmlotName?>
								</td>
								<? } ?>
				...
				<tr>
					<TD colspan="15" style="padding-left:10px;">
						<table cellpadding="1"  width="50%" cellspacing="1" border="0" bgcolor="#999999">
							...
							*/
							//echo $selBillingCompany;
							if($viewType=="lot")
							{	$rmlotName="";
								$rmlotRec=$dailycatchsummaryObj->getLotDetail($dsr[1],$selBillingCompany,$viewType);
								if(sizeof($rmlotRec)>0)
								{
									foreach($rmlotRec as $rmlots) 
									{ 
										if($rmlotName=="")
										{
											$rmlotName=$rmlots[1];
	...
	<tr>
		<TD colspan="16" style="padding-left:10px;" align="center">
			<table cellpadding="1"  width="30%" cellspacing="1" border="0" bgcolor="#999999">
				...
				<tr bgcolor="WHITE">
					<? ($viewType=="lot")? $colspan="3":$colspan="2"?>
					<td class="listing-head" nowrap style="padding-left:5px; padding-right:5px;" align="right" colspan="<?=$colspan?>">Total:</td>				
