<?php
	...
	if ($p["cmdAddPlant"]!="") {
		...
		if ($no!="" && $name!="") {
			$plantRecIns	=	$plantandunitObj->addPlant($company,$no, $name,$stdProduction,$basedOn);
			if ($plantRecIns) {
	...
	if ($p["cmdSaveChange"]!="") {
		...
		$basedOn	=	addSlash($p["basedOn"]);
		if ($plantId!="" && $no!="" && $name!="") {
			$plantRecUptd	= $plantandunitObj->updatePlant($plantId,$company, $no, $name,$stdProduction,$basedOn);
		}
											...
											<tr>
												...
												<td>
													<select name="company" id="company">
														...
														<? foreach($companyRecords as $cmp=>$cmpName)
														{
