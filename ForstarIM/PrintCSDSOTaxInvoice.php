				...
				<TR>
					...
					<td align="right">
						<table cellpadding="0" cellspacing="0">
							...
							<tr>
								<TD class="print-SOTHead-item"><?=$addr["ADR5"];?></TD>
							</tr>
						</table>
					</td>
				</TR>
...
<!-- 	Discount Splitup -->
  ...
  <tr >
	<TD colspan="17" align="center" >
		<table width='99%' cellpadding='0' cellspacing='0' align="center" style="border-top-width:0px">
		...
		<tr>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					<TD valign="top">
						<table width="99%" cellpadding="2" cellspacing="0"   style="border-left-width:0px;">		
							<tr>
								<TD >
								<table cellspacing='0' cellpadding='0' width="100%" >
					<tr>
	...
	<!-- 	Remarks	 -->
				...
				<TR>
					<TD valign="top"></td>
					<td rowspan="5" valign="bottom" style="line-height:100px;">
						<table width="100%" align="right" cellpadding="0" cellspacing="0" style="border-right-width:0px; border-top-width:0px; border-left-width:0px;border-bottom-width:0px;" >
							<tr>
								<td class="listing-item" nowrap align="left" style="padding-left:5px;">
								For <strong><?=$forstinsfoods["fifoods"];?> <br>
								<span style="font-size:7pt;"><?=$divfrfoods["frfoods"];?></span>
...
<!--  style="border-left-width:0px;border-top-width:0px;border-right-width:0px;border-bottom-width:0px;"-->
		...
		<tr>
			<td valign="top">
			<table width="99%" cellpadding="2" cellspacing="0"  style="border-left-width:0px;border-top-width:0px;border-right-width:0px;border-bottom-width:0px;">	
