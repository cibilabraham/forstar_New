						...
						<td   bgcolor="white">
							...
							<table cellpadding="0"  width="100%" cellspacing="0" border="0" align="center">
								<!--<tr>
									...
									<td background="images/heading_bg.gif" class="pageName">&nbsp;Product Master</td>
	...
	<table align="center" width="50%">
		...
		?>
					...
					<? if ($productGroupExist) {?>
						...
						<? }?>
						<!--tr>
                                                  <td class="fieldName" nowrap>Semi-Finished:</td>
                                                  <td class="listing-item" nowrap="true">
							<INPUT type="checkbox" name="semiFinished" value="Y" class="chkBox" <?=$sFinishedChk?>>
