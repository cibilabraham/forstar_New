<?
	...
	#List All  Labelling Stage Record
						...
						<td   bgcolor="white">
							...
							<table cellpadding="0"  width="100%" cellspacing="0" border="0" align="center">
								<tr>
									...
									<td  colspan="2" background="images/heading_bg.gif" class="pageName" >Labelling Stage </td>
								</tr>
									...
									<td colspan="2" >
										<table cellpadding="1"  width="75%" cellspacing="1" border="0" align="center" bgcolor="#999999">
											...
											<tr  bgcolor="#f2f2f2" align="center">
												<td class="listing-head" nowrap>Label </td>
											...
											?>
											<tr  bgcolor="WHITE"  >
												<td height="25" nowrap class="listing-item" style="padding-left:10px;"><?=$labellingStageName;?></td>
												<td class="listing-item" nowrap="nowrap" style="padding-left:10px;"><?=$labellingStageDescr;?></td>
												<? if($edit==true){?>
											  <? }?>
											</tr>
											<?
