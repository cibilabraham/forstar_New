									...
									<td colspan="2" >
										<table cellpadding="1"  width="75%" cellspacing="1" border="0" align="center" bgcolor="#999999">
											...
											<tr  bgcolor="#f2f2f2" align="center">
												<td class="listing-head" nowrap> RM Stage </td>
											...
											?>
											<tr  bgcolor="WHITE"  >
												<td height="25" nowrap class="listing-item" style="padding-left:10px;"><?=$freezingStageName;?></td>
												<td class="listing-item" nowrap="nowrap" style="padding-left:10px;"><?=$freezingStageDescr;?></td>
												<? if($edit!=true){?>
											  <? }?>
											</tr>
											<?
